import {
  require_js,
  require_sha
} from "./chunk-JX6NZHN7.js";
import "./chunk-W7OU6MBR.js";
import {
  require_events
...
function _(l3, u3, t3) {
  var i3, r4, o3, e3 = {};
  for (o3 in u3)
    "key" == o3 ? i3 = u3[o3] : "ref" == o3 ? r4 = u3[o3] : e3[o3] = u3[o3];
...
function $() {
  for (var n2, u3, t3, r4, o3, f3, c3, s3 = 1; i.length; )
...
function I(n2, l3, u3, t3, i3, r4, o3, e3, f3, c3, s3) {
  ...
  for (f3 = P(u3, l3, m3, f3, b3), a3 = 0; a3 < b3; a3++)
    null != (y3 = u3.__k[a3]) && (h3 = -1 == y3.__i ? p : m3[y3.__i] || p, y3.__i = a3, g3 = O(n2, y3, h3, i3, r4, o3, e3, f3, c3, s3), w3 = y3.__e, y3.ref && h3.ref != y3.ref && (h3.ref && B(h3.ref, null, y3), s3.push(y3.ref, y3.__c || w3, y3)), null == d3 && null != w3 && (d3 = w3), (_3 = !!(4 & y3.__u)) || h3.__k === y3.__k ? f3 = A(y3, f3, n2, _3) : "function" == typeof y3.type && void 0 !== g3 ? f3 = g3 : w3 && (f3 = w3.nextSibling), y3.__u &= -7);
  return u3.__e = d3, f3;
}
function P(n2, l3, u3, t3, i3) {
  ...
  if (a3)
    for (r4 = 0; r4 < s3; r4++)
      null != (e3 = u3[r4]) && 0 == (2 & e3.__u) && (e3.__e == t3 && (t3 = S(e3)), D(e3, e3));
  return t3;
}
function A(n2, l3, u3, t3) {
  var i3, r4;
  if ("function" == typeof n2.type) {
    for (i3 = n2.__k, r4 = 0; i3 && r4 < i3.length; r4++)
      i3[r4] && (i3[r4].__ = n2, l3 = A(i3[r4], l3, u3, t3));
    return l3;
  }
...
function L(n2, l3, u3, t3) {
  ...
  if (t3 > (s3 ? 1 : 0)) {
    for (i3 = u3 - 1, r4 = u3 + 1; i3 >= 0 || r4 < l3.length; )
      if (null != (c3 = l3[o3 = i3 >= 0 ? i3-- : r4++]) && 0 == (2 & c3.__u) && e3 == c3.key && f3 == c3.type)
        return o3;
  }
  return -1;
}
...
function j(n2, l3, u3, t3, i3) {
  ...
  n:
    if ("style" == l3)
      ...
      r4 = l3 != (l3 = l3.replace(f, "$1")), o3 = l3.toLowerCase(), l3 = o3 in n2 || "onFocusOut" == l3 || "onFocusIn" == l3 ? o3.slice(2) : l3.slice(2), n2.l || (n2.l = {}), n2.l[l3 + r4] = u3, u3 ? t3 ? u3.u = t3.u : (u3.u = c, n2.addEventListener(l3, r4 ? a : s, r4)) : n2.removeEventListener(l3, r4 ? a : s, r4);
    else {
...
function O(n2, u3, t3, i3, r4, o3, e3, f3, c3, s3) {
  ...
  n:
    if ("function" == typeof j3)
      ...
      null == o3 && u3.__v == t3.__v ? (u3.__k = t3.__k, u3.__e = t3.__e) : f3 = u3.__e = q(t3.__e, u3, t3, i3, r4, o3, e3, c3, s3);
...
function q(u3, t3, i3, r4, o3, e3, f3, c3, s3) {
  ...
  if (null == x3)
    ...
    else if (v3 && (u3.innerHTML = ""), I("template" == t3.type ? u3.content : u3, w(y3) ? y3 : [y3], t3, i3, r4, "foreignObject" == x3 ? "http://www.w3.org/1999/xhtml" : o3, e3, f3, e3 ? e3[0] : i3.__k && S(i3, 0), c3, s3), null != e3)
      for (a3 = e3.length; a3--; )
        g(e3[a3]);
...
function D(n2, u3, t3) {
  ...
  if (i3 = n2.__k)
    for (r4 = 0; r4 < i3.length; r4++)
      i3[r4] && D(i3[r4], u3, t3 || "function" != typeof n2.type);
...
function K(l3, u3, t3) {
  ...
  for (o3 in l3.type && l3.type.defaultProps && (e3 = l3.type.defaultProps), u3)
    "key" == o3 ? i3 = u3[o3] : "ref" == o3 ? r4 = u3[o3] : f3[o3] = void 0 === u3[o3] && null != e3 ? e3[o3] : u3[o3];
  ...
  "node_modules/preact/dist/preact.module.js"() {
    ...
    n = v.slice, l = { __e: function(n2, l3, u3, t3) {
      for (var i3, r4, o3; l3 = l3.__; )
        if ((i3 = l3.__c) && !i3.__)
          try {
            if ((r4 = i3.constructor) && null != r4.getDerivedStateFromError && (i3.setState(r4.getDerivedStateFromError(n2)), o3 = i3.__d), null != i3.componentDidCatch && (i3.componentDidCatch(n2, t3 || {}), o3 = i3.__d), o3)
              return i3.__E = i3;
          } catch (l4) {
            n2 = l4;
          }
...
//# sourceMappingURL=dist-NZJYCULT.js.map
