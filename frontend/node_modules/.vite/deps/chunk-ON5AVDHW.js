    ...
    if (g2[n3])
      i2[n3] = function(v2) {
        return new Promise(function(a, b2) {
          q.push([n3, v2, a, b2]) > 1 || resume(n3, v2);
        });
      };
  }
    ...
    function hashBlocks(w2, v2, p2, pos, len) {
      while (len >= 64) {
        ...
        for (var i2 = 0; i2 < 16; i2++) {
          var j2 = pos + i2 * 4;
          w2[i2] = binary_1.readUint32BE(p2, j2);
        }
        ...
        for (var i2 = 0; i2 < 64; i2++) {
          ...
          var t2 = ((a >>> 2 | a << 32 - 2) ^ (a >>> 13 | a << 32 - 13) ^ (a >>> 22 | a << 32 - 22)) + (a & b2 ^ a & c2 ^ b2 & c2) | 0;
          h2 = g2;
          g2 = f2;
          f2 = e2;
          e2 = d2 + t1 | 0;
...
var require_x25519 = __commonJS({
  "node_modules/@stablelib/x25519/lib/x25519.js"(exports) {
    ...
    function add(o2, a, b2) {
      for (let i2 = 0; i2 < 16; i2++) {
        o2[i2] = a[i2] + b2[i2];
      }
    }
    function sub(o2, a, b2) {
      for (let i2 = 0; i2 < 16; i2++) {
        o2[i2] = a[i2] - b2[i2];
      }
    }
    function mul(o2, a, b2) {
    ...
    function scalarMult(n3, p2) {
      ...
      const a = gf(), b2 = gf(), c2 = gf(), d2 = gf(), e2 = gf(), f2 = gf();
...
function unfetch_module_default(e2, n3) {
  return n3 = n3 || {}, new Promise(function(t, r2) {
    var s2 = new XMLHttpRequest(), o2 = [], u = [], i2 = {}, a = function() {
    ...
    for (var l2 in s2.open(n3.method || "get", e2, true), s2.onload = function() {
      s2.getAllResponseHeaders().replace(/^(.*?):[^\S\n]*([\s\S]*?)$/gm, function(e3, n4, t2) {
        o2.push(n4 = n4.toLowerCase()), u.push([n4, t2]), i2[n4] = i2[n4] ? i2[n4] + "," + t2 : t2;
      }), t(a());
...
function E(r2, e2, t = n2) {
  const o2 = w(r2, e2, t), a = r2.child({ context: o2 });
  return b(a, o2, t);
}
function C(r2) {
  var e2, t;
  const o2 = new m((e2 = r2.opts) == null ? void 0 : e2.level, r2.maxSizeInBytes);
  return { logger: (0, import_pino.default)(g(i({}, r2.opts), { level: "trace", browser: g(i({}, (t = r2.opts) == null ? void 0 : t.browser), { write: (a) => o2.write(a) }) })), chunkLoggerController: o2 };
}
function I(r2) {
  var e2;
...
function Cn(t, e2, n3, r2) {
  ...
  const o2 = BigInt(32), s2 = BigInt(4294967295), a = Number(n3 >> o2 & s2), u = Number(n3 & s2), i2 = r2 ? 4 : 0, D = r2 ? 0 : 4;
  t.setUint32(e2 + i2, a, r2), t.setUint32(e2 + D, u, r2);
}
var An = class extends xn {
  constructor(e2, n3, r2, o2) {
    super(), this.blockLen = e2, this.outputLen = n3, this.padOffset = r2, this.isLE = o2, this.finished = false, this.length = 0, this.pos = 0, this.destroyed = false, this.buffer = new Uint8Array(e2), this.view = _t(this.buffer);
  }
  update(e2) {
    De(this);
    ...
    const s2 = e2.length;
    for (let a = 0; a < s2; ) {
      const u = Math.min(o2 - this.pos, s2 - a);
      if (u === o2) {
        const i2 = _t(e2);
        for (; o2 <= s2 - a; a += o2)
          this.process(i2, a);
      ...
      r2.set(e2.subarray(a, a + u), this.pos), this.pos += u, a += u, this.pos === o2 && (this.process(n3, 0), this.pos = 0);
    }
  ...
  digestInto(e2) {
    ...
    let { pos: a } = this;
    n3[a++] = 128, this.buffer.subarray(a).fill(0), this.padOffset > o2 - a && (this.process(r2, 0), a = 0);
    for (let l2 = a; l2 < o2; l2++)
      n3[l2] = 0;
    Cn(r2, o2 - 8, BigInt(this.length * 8), s2), this.process(r2, 0);
    const u = _t(e2), i2 = this.outputLen;
    if (i2 % 4)
      throw new Error("_sha2: outputLen should be aligned to 32bit");
    const D = i2 / 4, c2 = this.get();
    if (D > c2.length)
      throw new Error("_sha2: outputLen bigger than state");
    for (let l2 = 0; l2 < D; l2++)
      u.setUint32(4 * l2, c2[l2], s2);
  }
  digest() {
  ...
  _cloneInto(e2) {
    ...
    const { blockLen: n3, buffer: r2, length: o2, finished: s2, destroyed: a, pos: u } = this;
    return e2.length = o2, e2.pos = u, e2.finished = s2, e2.destroyed = a, o2 % n3 && e2.buffer.set(r2), e2;
  }
};
...
var jn = (t, e2, n3, r2, o2) => e2 + n3 + r2 + o2 + (t / 2 ** 32 | 0) | 0;
var Zn = (t, e2, n3, r2, o2) => (t >>> 0) + (e2 >>> 0) + (n3 >>> 0) + (r2 >>> 0) + (o2 >>> 0);
var Gn = (t, e2, n3, r2, o2, s2) => e2 + n3 + r2 + o2 + s2 + (t / 2 ** 32 | 0) | 0;
...
var Jn = class extends An {
  ...
  get() {
    const { Ah: e2, Al: n3, Bh: r2, Bl: o2, Ch: s2, Cl: a, Dh: u, Dl: i2, Eh: D, El: c2, Fh: l2, Fl: p2, Gh: w2, Gl: h2, Hh: g2, Hl: S2 } = this;
    return [e2, n3, r2, o2, s2, a, u, i2, D, c2, l2, p2, w2, h2, g2, S2];
  }
  set(e2, n3, r2, o2, s2, a, u, i2, D, c2, l2, p2, w2, h2, g2, S2) {
    this.Ah = e2 | 0, this.Al = n3 | 0, this.Bh = r2 | 0, this.Bl = o2 | 0, this.Ch = s2 | 0, this.Cl = a | 0, this.Dh = u | 0, this.Dl = i2 | 0, this.Eh = D | 0, this.El = c2 | 0, this.Fh = l2 | 0, this.Fl = p2 | 0, this.Gh = w2 | 0, this.Gl = h2 | 0, this.Hh = g2 | 0, this.Hl = S2 | 0;
  }
  process(e2, n3) {
    for (let d2 = 0; d2 < 16; d2++, n3 += 4)
      P[d2] = e2.getUint32(n3), Q[d2] = e2.getUint32(n3 += 4);
    for (let d2 = 16; d2 < 80; d2++) {
      const m2 = P[d2 - 15] | 0, F = Q[d2 - 15] | 0, q = x2.rotrSH(m2, F, 1) ^ x2.rotrSH(m2, F, 8) ^ x2.shrSH(m2, F, 7), z2 = x2.rotrSL(m2, F, 1) ^ x2.rotrSL(m2, F, 8) ^ x2.shrSL(m2, F, 7), I2 = P[d2 - 2] | 0, O2 = Q[d2 - 2] | 0, ot = x2.rotrSH(I2, O2, 19) ^ x2.rotrBH(I2, O2, 61) ^ x2.shrSH(I2, O2, 6), tt = x2.rotrSL(I2, O2, 19) ^ x2.rotrBL(I2, O2, 61) ^ x2.shrSL(I2, O2, 6), st = x2.add4L(z2, tt, Q[d2 - 7], Q[d2 - 16]), at = x2.add4H(st, q, ot, P[d2 - 7], P[d2 - 16]);
      P[d2] = at | 0, Q[d2] = st | 0;
    }
    let { Ah: r2, Al: o2, Bh: s2, Bl: a, Ch: u, Cl: i2, Dh: D, Dl: c2, Eh: l2, El: p2, Fh: w2, Fl: h2, Gh: g2, Gl: S2, Hh: v2, Hl: L2 } = this;
    for (let d2 = 0; d2 < 80; d2++) {
      const m2 = x2.rotrSH(l2, p2, 14) ^ x2.rotrSH(l2, p2, 18) ^ x2.rotrBH(l2, p2, 41), F = x2.rotrSL(l2, p2, 14) ^ x2.rotrSL(l2, p2, 18) ^ x2.rotrBL(l2, p2, 41), q = l2 & w2 ^ ~l2 & g2, z2 = p2 & h2 ^ ~p2 & S2, I2 = x2.add5L(L2, F, z2, Yn[d2], Q[d2]), O2 = x2.add5H(I2, v2, m2, q, Vn[d2], P[d2]), ot = I2 | 0, tt = x2.rotrSH(r2, o2, 28) ^ x2.rotrBH(r2, o2, 34) ^ x2.rotrBH(r2, o2, 39), st = x2.rotrSL(r2, o2, 28) ^ x2.rotrBL(r2, o2, 34) ^ x2.rotrBL(r2, o2, 39), at = r2 & s2 ^ r2 & u ^ s2 & u, Ct = o2 & a ^ o2 & i2 ^ a & i2;
      v2 = g2 | 0, L2 = S2 | 0, g2 = w2 | 0, S2 = h2 | 0, w2 = l2 | 0, h2 = p2 | 0, { h: l2, l: p2 } = x2.add(D | 0, c2 | 0, O2 | 0, ot | 0), D = u | 0, c2 = i2 | 0, u = s2 | 0, i2 = a | 0, s2 = r2 | 0, a = o2 | 0;
      const At = x2.add3L(ot, st, Ct);
      r2 = x2.add3H(At, O2, tt, at), o2 = At | 0;
    }
    ({ h: r2, l: o2 } = x2.add(this.Ah | 0, this.Al | 0, r2 | 0, o2 | 0)), { h: s2, l: a } = x2.add(this.Bh | 0, this.Bl | 0, s2 | 0, a | 0), { h: u, l: i2 } = x2.add(this.Ch | 0, this.Cl | 0, u | 0, i2 | 0), { h: D, l: c2 } = x2.add(this.Dh | 0, this.Dl | 0, D | 0, c2 | 0), { h: l2, l: p2 } = x2.add(this.Eh | 0, this.El | 0, l2 | 0, p2 | 0), { h: w2, l: h2 } = x2.add(this.Fh | 0, this.Fl | 0, w2 | 0, h2 | 0), { h: g2, l: S2 } = x2.add(this.Gh | 0, this.Gl | 0, g2 | 0, S2 | 0), { h: v2, l: L2 } = x2.add(this.Hh | 0, this.Hl | 0, v2 | 0, L2 | 0), this.set(r2, o2, s2, a, u, i2, D, c2, l2, p2, w2, h2, g2, S2, v2, L2);
  }
  roundClean() {
    P.fill(0), Q.fill(0);
  }
...
function W(t, e2, n3) {
  ...
  const o2 = r2.length;
  if (typeof n3 == "number" && o2 !== n3)
    throw new Error(t + " of length " + n3 + " expected, got " + o2);
  return r2;
}
function ye(...t) {
  let e2 = 0;
...
function Ot(t, e2, n3 = {}) {
  const r2 = (o2, s2, a) => {
    ...
    if (!(a && i2 === void 0) && !u(i2, t))
      throw new Error("param " + String(o2) + " is invalid. Expected " + s2 + ", got " + i2);
  };
  for (const [o2, s2] of Object.entries(e2))
    r2(o2, s2, false);
  for (const [o2, s2] of Object.entries(n3))
    r2(o2, s2, true);
  return t;
}
function xe(t) {
...
function Ae(t, e2) {
  ...
  let n3 = H(t, e2), r2 = e2, o2 = M, s2 = N;
  for (; n3 !== M; ) {
    const u = r2 / n3, i2 = r2 % n3, D = o2 - s2 * u;
    r2 = n3, n3 = i2, o2 = s2, s2 = D;
  }
  if (r2 !== N)
...
function sr(t) {
  ...
  for (n3 = t - N, r2 = 0; n3 % nt === M; n3 /= nt, r2++)
    ;
  for (o2 = nt; o2 < t && or(o2, e2, t) !== t - N; o2++)
    if (o2 > 1e3)
  ...
  return function(u, i2) {
    if (u.pow(i2, e2) === u.neg(u.ONE))
      throw new Error("Cannot find square root");
    let D = r2, c2 = u.pow(u.mul(u.ONE, o2), n3), l2 = u.pow(i2, s2), p2 = u.pow(i2, n3);
    for (; !u.eql(p2, u.ONE); ) {
      if (u.eql(p2, u.ZERO))
        return u.ZERO;
      let w2 = 1;
      for (let g2 = u.sqr(p2); w2 < D && !u.eql(g2, u.ONE); w2++)
        g2 = u.sqr(g2);
      const h2 = u.pow(c2, N << BigInt(D - w2 - 1));
      c2 = u.sqr(h2), l2 = u.mul(l2, h2), p2 = u.mul(p2, c2), D = w2;
    }
    return l2;
  };
}
function ir(t) {
  ...
  if (t % Ce === Be) {
    const e2 = (t - Be) / Ce;
    return function(r2, o2) {
      const s2 = r2.mul(o2, nt), a = r2.pow(s2, e2), u = r2.mul(o2, a), i2 = r2.mul(r2.mul(u, nt), a), D = r2.mul(u, r2.sub(i2, r2.ONE));
      if (!r2.eql(r2.sqr(D), o2))
        throw new Error("Cannot find square root");
      return D;
    };
  }
...
function ar(t) {
  const e2 = { ORDER: "bigint", MASK: "bigint", BYTES: "isSafeInteger", BITS: "isSafeInteger" }, n3 = cr.reduce((r2, o2) => (r2[o2] = "function", r2), e2);
  return Ot(t, n3);
}
function fr(t, e2, n3) {
  if (n3 < M)
  ...
  let r2 = t.ONE, o2 = e2;
  for (; n3 > M; )
    n3 & N && (r2 = t.mul(r2, o2)), o2 = t.sqr(o2), n3 >>= N;
  return r2;
}
function Dr(t, e2) {
  const n3 = new Array(e2.length), r2 = e2.reduce((s2, a, u) => t.is0(a) ? s2 : (n3[u] = s2, t.mul(s2, a)), t.ONE), o2 = t.inv(r2);
  return e2.reduceRight((s2, a, u) => t.is0(a) ? s2 : (n3[u] = t.mul(s2, n3[u]), t.mul(s2, a)), o2), n3;
}
function me(t, e2) {
...
function _e(t, e2, n3 = false, r2 = {}) {
  ...
  const { nBitLength: o2, nByteLength: s2 } = me(t, e2);
  if (s2 > 2048)
    throw new Error("invalid field: expected ORDER of <= 2048 bytes");
  let a;
  const u = Object.freeze({ ORDER: t, isLE: n3, BITS: o2, BYTES: s2, MASK: er(o2), ZERO: M, ONE: N, create: (i2) => H(i2, t), isValid: (i2) => {
    if (typeof i2 != "bigint")
      throw new Error("invalid field element: expected bigint, got " + typeof i2);
    return M <= i2 && i2 < t;
  }, is0: (i2) => i2 === M, isOdd: (i2) => (i2 & N) === N, neg: (i2) => H(-i2, t), eql: (i2, D) => i2 === D, sqr: (i2) => H(i2 * i2, t), add: (i2, D) => H(i2 + D, t), sub: (i2, D) => H(i2 - D, t), mul: (i2, D) => H(i2 * D, t), pow: (i2, D) => fr(u, i2, D), div: (i2, D) => H(i2 * Ae(D, t), t), sqrN: (i2) => i2 * i2, addN: (i2, D) => i2 + D, subN: (i2, D) => i2 - D, mulN: (i2, D) => i2 * D, inv: (i2) => Ae(i2, t), sqrt: r2.sqrt || ((i2) => (a || (a = ir(t)), a(u, i2))), invertBatch: (i2) => Dr(u, i2), cmov: (i2, D, c2) => c2 ? D : i2, toBytes: (i2) => n3 ? Nt(i2, s2) : ge(i2, s2), fromBytes: (i2) => {
    if (i2.length !== s2)
...
function lr(t, e2) {
  return { constTimeNegate: zt, hasPrecomputes(n3) {
    ...
    let s2 = n3;
    for (; r2 > Se; )
      r2 & gt && (o2 = o2.add(s2)), s2 = s2.double(), r2 >>= gt;
    return o2;
    ...
    const D = BigInt(2 ** n3 - 1), c2 = 2 ** n3, l2 = BigInt(n3);
    for (let p2 = 0; p2 < s2; p2++) {
      const w2 = p2 * a;
      let h2 = Number(o2 & D);
      o2 >>= l2, h2 > a && (h2 -= c2, o2 += gt);
      const g2 = w2, S2 = w2 + Math.abs(h2) - 1, v2 = p2 % 2 !== 0, L2 = h2 < 0;
      h2 === 0 ? i2 = i2.add(zt(v2, r2[g2])) : u = u.add(zt(L2, r2[S2]));
    }
    return { p: u, f: i2 };
  }, wNAFUnsafe(n3, r2, o2, s2 = t.ZERO) {
    const { windows: a, windowSize: u } = Mt(n3, e2), i2 = BigInt(2 ** n3 - 1), D = 2 ** n3, c2 = BigInt(n3);
    for (let l2 = 0; l2 < a; l2++) {
      const p2 = l2 * u;
      if (o2 === Se)
        break;
      let w2 = Number(o2 & i2);
      if (o2 >>= c2, w2 > u && (w2 -= D, o2 += gt), w2 === 0)
        continue;
      let h2 = r2[p2 + Math.abs(w2) - 1];
      w2 < 0 && (h2 = h2.negate()), s2 = s2.add(h2);
    }
    return s2;
  }, getPrecomputes(n3, r2, o2) {
    let s2 = qt.get(r2);
    return s2 || (s2 = this.precomputeWindow(r2, n3), n3 !== 1 && qt.set(r2, o2(s2))), s2;
  }, wNAFCached(n3, r2, o2) {
    const s2 = $t(n3);
    return this.wNAF(s2, this.getPrecomputes(s2, n3, o2), r2);
  }, wNAFCachedUnsafe(n3, r2, o2, s2) {
    const a = $t(n3);
    return a === 1 ? this.unsafeLadder(n3, r2, s2) : this.wNAFUnsafe(a, this.getPrecomputes(a, n3, o2), r2, s2);
  }, setWindowSize(n3, r2) {
...
function br(t, e2, n3, r2) {
  ...
  const o2 = t.ZERO, s2 = tr(BigInt(n3.length)), a = s2 > 12 ? s2 - 3 : s2 > 4 ? s2 - 2 : s2 ? 2 : 1, u = (1 << a) - 1, i2 = new Array(u + 1).fill(o2), D = Math.floor((e2.BITS - 1) / a) * a;
  let c2 = o2;
  for (let l2 = D; l2 >= 0; l2 -= a) {
    i2.fill(o2);
    for (let w2 = 0; w2 < r2.length; w2++) {
      const h2 = r2[w2], g2 = Number(h2 >> BigInt(l2) & BigInt(u));
      i2[g2] = i2[g2].add(n3[w2]);
    }
    let p2 = o2;
    for (let w2 = i2.length - 1, h2 = o2; w2 > 0; w2--)
      h2 = h2.add(i2[w2]), p2 = p2.add(h2);
    if (c2 = c2.add(p2), l2 !== 0)
...
function yr(t) {
  const e2 = gr(t), { Fp: n3, n: r2, prehash: o2, hash: s2, randomBytes: a, nByteLength: u, h: i2 } = e2, D = yt << BigInt(u * 8) - j, c2 = n3.create, l2 = _e(e2.n, e2.nBitLength), p2 = e2.uvRatio || ((y2, f2) => {
    try {
      return { isValid: true, value: n3.sqrt(y2 * n3.inv(f2)) };
    } catch {
      return { isValid: false, value: G };
    }
  }), w2 = e2.adjustScalarBytes || ((y2) => y2), h2 = e2.domain || ((y2, f2, b2) => {
    if (Tt("phflag", b2), f2.length || b2)
      throw new Error("Contexts/pre-hash are not supported");
    return y2;
  });
  function g2(y2, f2) {
    ft("coordinate " + y2, f2, G, D);
  }
  function S2(y2) {
    if (!(y2 instanceof d2))
  ...
  const v2 = xe((y2, f2) => {
    const { ex: b2, ey: E2, ez: B2 } = y2, C3 = y2.is0();
    f2 == null && (f2 = C3 ? wr : n3.inv(B2));
    const A2 = c2(b2 * f2), U2 = c2(E2 * f2), _2 = c2(B2 * f2);
    if (C3)
      return { x: G, y: j };
    if (_2 !== j)
    ...
    const { ex: E2, ey: B2, ez: C3, et: A2 } = y2, U2 = c2(E2 * E2), _2 = c2(B2 * B2), T2 = c2(C3 * C3), $ = c2(T2 * T2), R = c2(U2 * f2), V = c2(T2 * c2(R + _2)), Y = c2($ + c2(b2 * c2(U2 * _2)));
    if (V !== Y)
      throw new Error("bad point: equation left != right (1)");
    const Z = c2(E2 * B2), X = c2(C3 * A2);
    if (Z !== X)
      throw new Error("bad point: equation left != right (2)");
    return true;
  });
  class d2 {
    constructor(f2, b2, E2, B2) {
      this.ex = f2, this.ey = b2, this.ez = E2, this.et = B2, g2("x", f2), g2("y", b2), g2("z", E2), g2("t", B2), Object.freeze(this);
    }
    get x() {
    ...
    static normalizeZ(f2) {
      ...
      return f2.map((E2, B2) => E2.toAffine(b2[B2])).map(d2.fromAffine);
    }
    static msm(f2, b2) {
      return br(d2, l2, f2, b2);
    }
    _setWindowSize(f2) {
    ...
    equals(f2) {
      S2(f2);
      const { ex: b2, ey: E2, ez: B2 } = this, { ex: C3, ey: A2, ez: U2 } = f2, _2 = c2(b2 * U2), T2 = c2(C3 * B2), $ = c2(E2 * U2), R = c2(A2 * B2);
      return _2 === T2 && $ === R;
    }
    is0() {
    ...
    double() {
      const { a: f2 } = e2, { ex: b2, ey: E2, ez: B2 } = this, C3 = c2(b2 * b2), A2 = c2(E2 * E2), U2 = c2(yt * c2(B2 * B2)), _2 = c2(f2 * C3), T2 = b2 + E2, $ = c2(c2(T2 * T2) - C3 - A2), R = _2 + A2, V = R - U2, Y = _2 - A2, Z = c2($ * V), X = c2(R * Y), et = c2($ * Y), pt = c2(V * R);
      return new d2(Z, X, pt, et);
    }
    add(f2) {
      S2(f2);
      const { a: b2, d: E2 } = e2, { ex: B2, ey: C3, ez: A2, et: U2 } = this, { ex: _2, ey: T2, ez: $, et: R } = f2;
      if (b2 === BigInt(-1)) {
        const re = c2((C3 - B2) * (T2 + _2)), oe = c2((C3 + B2) * (T2 - _2)), mt = c2(oe - re);
        if (mt === G)
          return this.double();
        const se = c2(A2 * yt * R), ie = c2(U2 * yt * $), ue = ie + se, ce = oe + re, ae = ie - se, Dn = c2(ue * mt), dn = c2(ce * ae), hn = c2(ue * ae), ln = c2(mt * ce);
        return new d2(Dn, dn, ln, hn);
      }
      const V = c2(B2 * _2), Y = c2(C3 * T2), Z = c2(U2 * E2 * R), X = c2(A2 * $), et = c2((B2 + C3) * (_2 + T2) - V - Y), pt = X - Z, ee = X + Z, ne = c2(Y - b2 * V), un = c2(et * pt), cn = c2(ee * ne), an = c2(et * ne), fn = c2(pt * ee);
    ...
    static fromHex(f2, b2 = false) {
      const { d: E2, a: B2 } = e2, C3 = n3.BYTES;
      f2 = W("pointHex", f2, C3), Tt("zip215", b2);
      const A2 = f2.slice(), U2 = f2[C3 - 1];
      A2[C3 - 1] = U2 & -129;
      const _2 = Et(A2), T2 = b2 ? D : n3.ORDER;
      ft("pointHex.y", _2, G, T2);
      const $ = c2(_2 * _2), R = c2($ - j), V = c2(E2 * $ - B2);
  ...
  const { BASE: m2, ZERO: F } = d2, q = lr(d2, u * 8);
  function z2(y2) {
    return H(y2, r2);
  }
  function I2(y2) {
  ...
  function O2(y2) {
    ...
    const b2 = W("hashed private key", s2(y2), 2 * f2), E2 = w2(b2.slice(0, f2)), B2 = b2.slice(f2, 2 * f2), C3 = I2(E2), A2 = m2.multiply(C3), U2 = A2.toRawBytes();
    return { head: E2, prefix: B2, scalar: C3, point: A2, pointBytes: U2 };
  }
  function ot(y2) {
  ...
  function tt(y2 = new Uint8Array(), ...f2) {
    const b2 = ye(...f2);
    return I2(s2(h2(b2, W("context", y2), !!o2)));
  }
  function st(y2, f2, b2 = {}) {
    y2 = W("message", y2), o2 && (y2 = o2(y2));
    const { prefix: E2, scalar: B2, pointBytes: C3 } = O2(f2), A2 = tt(b2.context, E2, y2), U2 = m2.multiply(A2).toRawBytes(), _2 = tt(b2.context, U2, C3, y2), T2 = z2(A2 + _2 * B2);
    ft("signature.s", T2, G, r2);
    const $ = ye(U2, Nt(T2, n3.BYTES));
    return W("result", $, n3.BYTES * 2);
  }
  const at = Er;
  function Ct(y2, f2, b2, E2 = at) {
    const { context: B2, zip215: C3 } = E2, A2 = n3.BYTES;
    y2 = W("signature", y2, 2 * A2), f2 = W("message", f2), b2 = W("publicKey", b2, A2), C3 !== void 0 && Tt("zip215", C3), o2 && (f2 = o2(f2));
    const U2 = Et(y2.slice(A2, 2 * A2));
    let _2, T2, $;
    try {
      _2 = d2.fromHex(b2, C3), T2 = d2.fromHex(y2.slice(0, A2), C3), $ = m2.multiplyUnsafe(U2);
    } catch {
      return false;
    }
    if (!C3 && _2.isSmallOrder())
      return false;
    const R = tt(B2, T2.toRawBytes(), _2.toRawBytes(), f2);
    return T2.add(_2.multiplyUnsafe(R)).subtract($).clearCofactor().equals(d2.ZERO);
  }
  return m2._setWindowSize(8), { CURVE: e2, getPublicKey: ot, sign: st, verify: Ct, ExtendedPoint: d2, utils: { getExtendedPublicKey: O2, randomPrivateKey: () => a(n3.BYTES), precompute(y2 = 8, f2 = d2.BASE) {
...
var Cr = BigInt(8);
function Ar(t) {
  const e2 = BigInt(10), n3 = BigInt(20), r2 = BigInt(40), o2 = BigInt(80), s2 = kt, u = t * t % s2 * t % s2, i2 = J(u, Te, s2) * u % s2, D = J(i2, xr, s2) * t % s2, c2 = J(D, Br, s2) * D % s2, l2 = J(c2, e2, s2) * c2 % s2, p2 = J(l2, n3, s2) * l2 % s2, w2 = J(p2, r2, s2) * p2 % s2, h2 = J(w2, o2, s2) * w2 % s2, g2 = J(h2, o2, s2) * w2 % s2, S2 = J(g2, e2, s2) * c2 % s2;
...
function _r(t, e2) {
  const n3 = kt, r2 = H(e2 * e2 * e2, n3), o2 = H(r2 * r2 * e2, n3), s2 = Ar(t * o2).pow_p_5_8;
  let a = H(t * r2 * s2, n3);
  const u = H(e2 * a * a, n3), i2 = a, D = H(a * Ue, n3), c2 = u === t, l2 = u === H(-t, n3), p2 = u === H(-t * Ue, n3);
  return c2 && (a = i2), (l2 || p2) && (a = D), ur(a, n3) && (a = H(-a, n3)), { isValid: c2 || l2, value: a };
}
...
function Ir(t, e2) {
  ...
  for (var o2 = 0; o2 < t.length; o2++) {
    var s2 = t.charAt(o2), a = s2.charCodeAt(0);
    if (n3[a] !== 255)
      throw new TypeError(s2 + " is ambiguous");
    n3[a] = o2;
  }
  var u = t.length, i2 = t.charAt(0), D = Math.log(u) / Math.log(256), c2 = Math.log(256) / Math.log(u);
  function l2(h2) {
    ...
    if (h2.length === 0)
      return "";
    for (var g2 = 0, S2 = 0, v2 = 0, L2 = h2.length; v2 !== L2 && h2[v2] === 0; )
      v2++, g2++;
    for (var d2 = (L2 - v2) * c2 + 1 >>> 0, m2 = new Uint8Array(d2); v2 !== L2; ) {
      for (var F = h2[v2], q = 0, z2 = d2 - 1; (F !== 0 || q < S2) && z2 !== -1; z2--, q++)
        F += 256 * m2[z2] >>> 0, m2[z2] = F % u >>> 0, F = F / u >>> 0;
      if (F !== 0)
        throw new Error("Non-zero carry");
      S2 = q, v2++;
    }
    for (var I2 = d2 - S2; I2 !== d2 && m2[I2] === 0; )
      I2++;
    for (var O2 = i2.repeat(g2); I2 < d2; ++I2)
      O2 += t.charAt(m2[I2]);
    return O2;
  }
  function p2(h2) {
    ...
    var g2 = 0;
    if (h2[g2] !== " ") {
      for (var S2 = 0, v2 = 0; h2[g2] === i2; )
        S2++, g2++;
      for (var L2 = (h2.length - g2) * D + 1 >>> 0, d2 = new Uint8Array(L2); h2[g2]; ) {
        var m2 = n3[h2.charCodeAt(g2)];
        if (m2 === 255)
          return;
        for (var F = 0, q = L2 - 1; (m2 !== 0 || F < v2) && q !== -1; q--, F++)
          m2 += u * d2[q] >>> 0, d2[q] = m2 % 256 >>> 0, m2 = m2 / 256 >>> 0;
        if (m2 !== 0)
          throw new Error("Non-zero carry");
        v2 = F, g2++;
      }
      if (h2[g2] !== " ") {
        for (var z2 = L2 - v2; z2 !== L2 && d2[z2] === 0; )
          z2++;
        for (var I2 = new Uint8Array(S2 + (L2 - z2)), O2 = S2; z2 !== L2; )
          I2[O2++] = d2[z2++];
        return I2;
      }
    }
...
var zr = class {
  constructor(e2, n3, r2, o2) {
    this.name = e2, this.prefix = n3, this.baseEncode = r2, this.baseDecode = o2, this.encoder = new Lr(e2, n3, r2), this.decoder = new Or(e2, n3, o2);
  }
  encode(e2) {
...
var ht = ({ prefix: t, name: e2, alphabet: n3 }) => {
  const { encode: r2, decode: o2 } = Tr(n3, e2);
...
var Mr = (t, e2, n3, r2) => {
  ...
  for (let c2 = 0; c2 < s2; ++c2) {
    ...
    i2 = i2 << n3 | l2, u += n3, u >= 8 && (u -= 8, a[D++] = 255 & i2 >> u);
  }
  if (u >= n3 || 255 & i2 << 8 - u)
...
var qr = (t, e2, n3) => {
  ...
  for (let i2 = 0; i2 < t.length; ++i2)
    for (u = u << 8 | t[i2], a += 8; a > n3; )
      a -= n3, s2 += e2[o2 & u >> a];
  if (a && (s2 += e2[o2 & u << n3 - a]), r2)
    for (; s2.length * n3 & 7; )
      s2 += "=";
  return s2;
};
var k2 = ({ name: t, prefix: e2, bitsPerChar: n3, alphabet: r2 }) => Bt({ prefix: e2, name: t, encode(o2) {
  return qr(o2, r2, n3);
}, decode(o2) {
  return Mr(o2, r2, n3, t);
} });
...
var ke = 127;
function Pt(t, r2) {
  var n3 = 0, r2 = r2 || 0, o2 = 0, s2 = r2, a, u = t.length;
  do {
    if (s2 >= u)
      throw Pt.bytes = 0, new RangeError("Could not decode varint");
    a = t[s2++], n3 += o2 < 28 ? (a & ke) << o2 : (a & ke) * Math.pow(2, o2), o2 += 7;
  } while (a >= Uo);
...
var Qt = (t, e2) => {
  const n3 = e2.byteLength, r2 = Ze(t), o2 = r2 + Ze(n3), s2 = new Uint8Array(o2 + n3);
  return je(t, s2, 0), je(n3, s2, r2), s2.set(e2, o2), new Ro(t, n3, e2, s2);
};
var Ro = class {
  constructor(e2, n3, r2, o2) {
...
function sn(t) {
  const e2 = t.split(ut), n3 = lt(e2[0]), r2 = lt(e2[1]), o2 = nn(e2[2]), s2 = rt(e2.slice(0, 2).join(ut), xt);
...
async function Qo(t, e2, n3, r2, o2 = (0, import_time.fromMiliseconds)(Date.now())) {
  const s2 = { alg: jt, typ: Zt }, a = Qe(r2.publicKey), u = o2 + n3, i2 = { iss: a, sub: t, aud: e2, iat: o2, exp: u }, D = rn({ header: s2, payload: i2 }), c2 = Rt.sign(D, r2.secretKey.slice(0, 32));
...
*/
//# sourceMappingURL=chunk-ON5AVDHW.js.map
