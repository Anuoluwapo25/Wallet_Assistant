...
// node_modules/@thirdweb-dev/react/dist/paperWallet-765c291c.browser.esm.js
var import_react7 = __toESM(require_react());

// node_modules/@thirdweb-dev/react/dist/oneKeyWallet-aa6e0cdb.browser.esm.js
...
var DialogPortal = (props) => {
  ...
  return (0, import_jsx_runtime7.jsx)(PortalProvider2, { scope: __scopeDialog, forceMount, children: React17.Children.map(children, (child) => (0, import_jsx_runtime7.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime7.jsx)(Portal, { asChild: true, container, children: child }) })) });
};
...
var EmbeddedWalletFormUI = (props) => {
  ...
  const [inputMode, setInputMode] = (0, import_react5.useState)(selectDefaultInputMode());
  ...
  const switchInputMode = (0, import_react5.useCallback)(() => {
  ...
  return (0, import_jsx_runtime8.jsxs)(Container, {
    flex: "column",
    gap: "lg",
    style: {
      position: "relative"
    },
    children: [hasSocialLogins && (0, import_jsx_runtime8.jsx)(Container, {
      ...
      children: socialLogins.map((loginMethod) => {
        ...
        return (0, import_jsx_runtime8.jsxs)(SocialButton, {
          ...
          children: [(0, import_jsx_runtime8.jsx)(Img, {
    ...
    }), props.modalSize === "wide" && hasSocialLogins && isEmailEnabled && (0, import_jsx_runtime8.jsx)(TextDivider, {
      text: twLocale.connectWallet.or
    }), inputMode !== "none" && (0, import_jsx_runtime8.jsxs)(Container, {
      children: [inputMode === "email" ? (0, import_jsx_runtime8.jsx)(InputSelectionUI, {
        type,
        onSelect: (value) => {
          props.onSelect({
            email: value
      ...
      }) : (0, import_jsx_runtime8.jsx)(InputSelectionUI, {
        format: "phone",
        type,
        onSelect: (value) => {
          props.onSelect({
        ...
        emptyErrorMessage,
        submitButtonText: locale.submitEmail
      }), allowSwitchInputMode && (0, import_jsx_runtime8.jsxs)(import_jsx_runtime8.Fragment, {
        children: [(0, import_jsx_runtime8.jsx)(Spacer, {
          y: "md"
...
var EmbeddedWalletFormUIScreen = (props) => {
  ...
  const modalConfig = (0, import_react5.useContext)(ModalConfigCtx);
  return (0, import_jsx_runtime8.jsxs)(Container, {
    fullHeight: true,
    flex: "column",
    p: "lg",
    ...
    children: [(0, import_jsx_runtime8.jsx)(ModalHeader, {
      onBack: screen === props.walletConfig && initialScreen === props.walletConfig ? void 0 : props.onBack,
      title: locale.title
    }), isCompact ? (0, import_jsx_runtime8.jsx)(Spacer, {
      y: "xl"
    }) : null, (0, import_jsx_runtime8.jsx)(Container, {
      expand: true,
      flex: "column",
      center: "y",
      p: isCompact ? void 0 : "lg",
      children: (0, import_jsx_runtime8.jsx)(EmbeddedWalletFormUI, {
    ...
    }), isCompact && (modalConfig.showThirdwebBranding !== false || modalConfig.termsOfServiceUrl || modalConfig.privacyPolicyUrl) && (0, import_jsx_runtime8.jsx)(Spacer, {
      y: "xl"
    }), (0, import_jsx_runtime8.jsxs)(Container, {
      flex: "column",
      gap: "lg",
      children: [(0, import_jsx_runtime8.jsx)(TOS, {
        termsOfServiceUrl: modalConfig.termsOfServiceUrl,
        privacyPolicyUrl: modalConfig.privacyPolicyUrl
      }), modalConfig.showThirdwebBranding !== false && (0, import_jsx_runtime8.jsx)(PoweredByThirdweb, {})]
    })]
  });
};
...
var EmbeddedWalletSocialLogin = (props) => {
  ...
  const onConnectCalled = (0, import_react5.useRef)(false);
  ...
  return (0, import_jsx_runtime8.jsx)(Container, {
    animate: "fadein",
    flex: "column",
    fullHeight: true,
    children: (0, import_jsx_runtime8.jsxs)(Container, {
      flex: "column",
      expand: true,
      p: "lg",
      style: {
      ...
      children: [(0, import_jsx_runtime8.jsx)(ModalHeader, {
        title: locale.title,
        onBack: goBack
      }), modalSize === "compact" ? (0, import_jsx_runtime8.jsx)(Spacer, {
        y: "xl"
      }) : null, (0, import_jsx_runtime8.jsxs)(Container, {
        flex: "column",
        center: "both",
        expand: true,
        style: {
        ...
        children: [connectionStatus === "connecting" && (0, import_jsx_runtime8.jsxs)(Container, {
          animate: "fadein",
          children: [(0, import_jsx_runtime8.jsx)(Text, {
            color: "primaryText",
            center: true,
            multiline: true,
            style: {
          ...
          }), (0, import_jsx_runtime8.jsx)(Spacer, {
            y: "xl"
          }), (0, import_jsx_runtime8.jsx)(Container, {
            center: "x",
            flex: "row",
            children: (0, import_jsx_runtime8.jsx)(Spinner, {
              size: "lg",
              color: "accentText"
            })
          }), (0, import_jsx_runtime8.jsx)(Spacer, {
        ...
        }), connectionStatus === "disconnected" && (0, import_jsx_runtime8.jsxs)(Container, {
          animate: "fadein",
          children: [(0, import_jsx_runtime8.jsx)(Text, {
            color: "danger",
            children: locale.failed
          }), authError && (0, import_jsx_runtime8.jsx)(Text, {
            color: "danger",
            children: authError
          }), (0, import_jsx_runtime8.jsx)(Spacer, {
            y: "lg"
...
function OTPInput(props) {
  ...
  const boxEls = (0, import_react5.useRef)([]);
  (0, import_react5.useEffect)(() => {
  ...
  return (0, import_jsx_runtime8.jsx)(Container, {
    ...
    children: new Array(props.digits).fill(null).map((_, i) => {
      return (0, import_jsx_runtime8.jsx)(OTPInputBox, {
...
function CreatePassword(props) {
  ...
  return (0, import_jsx_runtime8.jsxs)(Container, {
    ...
    flex: "column",
    animate: "fadein",
    children: [(0, import_jsx_runtime8.jsx)(Container, {
      p: "lg",
      children: (0, import_jsx_runtime8.jsx)(ModalHeader, {
        title: locale.title,
        onBack: props.goBack
      })
    }), (0, import_jsx_runtime8.jsx)(Line, {}), (0, import_jsx_runtime8.jsxs)(Container, {
      expand: true,
      ...
      children: [props.modalSize === "compact" && (0, import_jsx_runtime8.jsx)(Spacer, {
        y: "xxl"
      }), (0, import_jsx_runtime8.jsx)(Container, {
        flex: "row",
        center: "x",
        color: "accentText",
        children: (0, import_jsx_runtime8.jsx)(BounceContainer, {
          children: (0, import_jsx_runtime8.jsx)(LockOpen1Icon, {
            width: iconSize.xxl,
            height: iconSize.xxl
          })
        })
        ...
        y: "xl"
      }), (0, import_jsx_runtime8.jsxs)("form", {
        onSubmit: async (e) => {
          e.preventDefault();
          setLoading(false);
          setError(false);
        ...
        children: [(0, import_jsx_runtime8.jsx)(Text, {
          ...
          y: "xs"
        }), (0, import_jsx_runtime8.jsx)(Text, {
          center: true,
          color: "primaryText",
          children: locale.saveInstruction
        }), (0, import_jsx_runtime8.jsx)(Spacer, {
          y: "xl"
        }), (0, import_jsx_runtime8.jsxs)(InputContainer, {
          ...
          }), (0, import_jsx_runtime8.jsx)(InputButton, {
            type: "button",
            onClick: () => setShowPassword(!showPassword),
            children: showPassword ? (0, import_jsx_runtime8.jsx)(EyeClosedIcon, {}) : (0, import_jsx_runtime8.jsx)(EyeOpenIcon, {})
          })]
        }), (0, import_jsx_runtime8.jsx)(Spacer, {
          y: "lg"
        }), (0, import_jsx_runtime8.jsxs)(Container, {
          ...
          gap: "sm",
          center: "y",
          children: [(0, import_jsx_runtime8.jsx)(CheckboxButton, {
            "aria-checked": saved,
            type: "button",
            id: "save-checkbox",
            onClick: () => {
            ...
            children: (0, import_jsx_runtime8.jsx)(CheckIcon, {
              width: 20,
              height: 20,
              style: {
                opacity: saved ? 1 : 0,
          ...
          }), (0, import_jsx_runtime8.jsx)("label", {
          ...
          type: "submit",
          children: loading ? (0, import_jsx_runtime8.jsx)(Spinner, {
            size: "md",
            color: "accentButtonText"
          }) : locale.submitButton
        }), error && (0, import_jsx_runtime8.jsxs)(Container, {
          children: [(0, import_jsx_runtime8.jsx)(Spacer, {
            y: "lg"
          }), (0, import_jsx_runtime8.jsx)(Text, {
            size: "sm",
...
function EnterPasswordOrRecovery(props) {
  ...
  return (0, import_jsx_runtime8.jsxs)(Container, {
    ...
    children: [(0, import_jsx_runtime8.jsx)(Container, {
    ...
    }), (0, import_jsx_runtime8.jsx)(Line, {}), (0, import_jsx_runtime8.jsx)(Spacer, {
      y: "xxl"
    }), (0, import_jsx_runtime8.jsx)(Container, {
      expand: true,
      flex: "column",
      ...
      children: (0, import_jsx_runtime8.jsxs)("form", {
        ...
        children: [(0, import_jsx_runtime8.jsx)(Text, {
        ...
        }), error && (0, import_jsx_runtime8.jsxs)(import_jsx_runtime8.Fragment, {
          children: [(0, import_jsx_runtime8.jsx)(Spacer, {
            y: "sm"
          }), (0, import_jsx_runtime8.jsx)(Text, {
            color: "danger",
          ...
          type: "submit",
          disabled: loading,
          children: loading ? (0, import_jsx_runtime8.jsx)(import_jsx_runtime8.Fragment, {
            children: (0, import_jsx_runtime8.jsx)(Spinner, {
              size: "md",
              color: "accentButtonText"
            })
          }) : (0, import_jsx_runtime8.jsx)(import_jsx_runtime8.Fragment, {
...
var EmbeddedWalletOTPLoginUI = (props) => {
  ...
  const [screen, setScreen] = (0, import_react5.useState)("base");
  ...
  if (screen === "create-password") {
    return (0, import_jsx_runtime8.jsx)(CreatePassword, {
      modalSize: props.modalSize,
      goBack: props.goBack,
  ...
  if (screen === "enter-password-or-recovery-code") {
    return (0, import_jsx_runtime8.jsx)(EnterPasswordOrRecovery, {
      modalSize: props.modalSize,
      goBack: props.goBack,
      ...
      children: [(0, import_jsx_runtime8.jsx)(Container, {
        ...
        children: (0, import_jsx_runtime8.jsxs)("form", {
          ...
          children: [(0, import_jsx_runtime8.jsxs)(Container, {
            ...
            center: "x",
            px: "lg",
            children: [!isWideModal && (0, import_jsx_runtime8.jsx)(Spacer, {
              y: "xl"
            }), (0, import_jsx_runtime8.jsx)(Text, {
          ...
          }), (0, import_jsx_runtime8.jsx)(OTPInput, {
          ...
          }), verifyStatus === "invalid" && (0, import_jsx_runtime8.jsxs)(FadeIn, {
            children: [(0, import_jsx_runtime8.jsx)(Spacer, {
              y: "md"
            }), (0, import_jsx_runtime8.jsx)(Text, {
              size: "sm",
          ...
          }), verifyStatus === "payment_required" && (0, import_jsx_runtime8.jsxs)(FadeIn, {
            children: [(0, import_jsx_runtime8.jsx)(Spacer, {
              y: "md"
            }), (0, import_jsx_runtime8.jsx)(Text, {
              size: "sm",
            ...
            children: verifyStatus === "verifying" ? (0, import_jsx_runtime8.jsx)(import_jsx_runtime8.Fragment, {
              children: (0, import_jsx_runtime8.jsx)(Container, {
                flex: "row",
                center: "x",
                animate: "fadein",
            ...
            y: "xl"
          }), !isWideModal && (0, import_jsx_runtime8.jsx)(Line, {}), (0, import_jsx_runtime8.jsxs)(Container, {
            p: isWideModal ? void 0 : "lg",
            children: [accountStatus === "error" && (0, import_jsx_runtime8.jsx)(import_jsx_runtime8.Fragment, {
              children: (0, import_jsx_runtime8.jsx)(Text, {
                size: "sm",
                center: true,
                color: "danger",
            ...
            }), accountStatus === "sending" && (0, import_jsx_runtime8.jsxs)(Container, {
              flex: "row",
              center: "both",
              gap: "xs",
              style: {
              ...
              }), (0, import_jsx_runtime8.jsx)(Spinner, {
                size: "xs",
                color: "secondaryText"
              })]
            }), typeof accountStatus === "object" && (0, import_jsx_runtime8.jsx)(LinkButton, {
...
var embeddedWallet = (options) => {
  ...
  return {
    ...
    selectUI(props) {
      return (0, import_jsx_runtime8.jsx)(EmbeddedWalletSelectionUI, {
        ...props,
        authOptions
      });
    },
    connectUI(props) {
      return (0, import_jsx_runtime8.jsx)(EmbeddedWalletConnectUI, {
        ...props,
        authOptions
      });
    }
...
var EmbeddedWalletSelectionUI = (props) => {
  ...
  if (props.modalSize === "wide" || screen !== reservedScreens.main && props.modalSize === "compact") {
    return (0, import_jsx_runtime8.jsx)(WalletEntryButton, {
      walletConfig: props.walletConfig,
      selectWallet: () => {
...
var EmbeddedWalletConnectUI = (props) => {
  const [loginType, setLoginType] = (0, import_react5.useState)(props.selectionData);
  if (loginType) {
    const handleBack = () => {
    ...
    if (typeof loginType !== "string") {
      return (0, import_jsx_runtime8.jsx)(EmbeddedWalletOTPLoginUI, {
        ...props,
        userInfo: loginType,
        goBack: handleBack
      });
    }
    return (0, import_jsx_runtime8.jsx)(EmbeddedWalletSocialLogin, {
      ...props,
      goBack: handleBack,
      strategy: loginType
    });
  }
  return (0, import_jsx_runtime8.jsx)(EmbeddedWalletFormUIScreen, {
    modalSize: props.modalSize,
...
var ExportLocalWallet = (props) => {
  ...
  const [password, setPassword] = (0, import_react5.useState)("");
  const [showPassword, setShowPassword] = (0, import_react5.useState)(false);
  const [isWrongPassword, setIsWrongPassword] = (0, import_react5.useState)(false);
  const [passwordIsRequired, setPasswordIsRequired] = (0, import_react5.useState)(false);
  const wallet = props.walletInstance;
  const [savedAddress, setSavedAddress] = (0, import_react5.useState)("");
  ...
  return (0, import_jsx_runtime8.jsx)(Container, {
    ...
    children: (0, import_jsx_runtime8.jsxs)("form", {
      ...
      children: [(0, import_jsx_runtime8.jsx)(Container, {
        ...
        expand: true,
        p: "lg",
        children: [(0, import_jsx_runtime8.jsx)(ModalDescription, {
          children: locale.exportScreen.description1
        }), (0, import_jsx_runtime8.jsx)(Spacer, {
          y: "sm"
        }), (0, import_jsx_runtime8.jsx)(ModalDescription, {
          ...
          y: "sm"
        }), (0, import_jsx_runtime8.jsx)(SavedWalletAddress, {
          children: shortenAddress(savedAddress)
        }), passwordIsRequired && (0, import_jsx_runtime8.jsxs)(import_jsx_runtime8.Fragment, {
          children: [(0, import_jsx_runtime8.jsx)(Spacer, {
            y: "lg"
          ...
          }), (0, import_jsx_runtime8.jsx)(FormFieldWithIconButton, {
            noSave: true,
            required: true,
            ...
            right: {
              onClick: () => setShowPassword(!showPassword),
              icon: showPassword ? (0, import_jsx_runtime8.jsx)(EyeClosedIcon, {}) : (0, import_jsx_runtime8.jsx)(EyeOpenIcon, {})
            },
      ...
      }), (0, import_jsx_runtime8.jsx)(ScreenBottomContainer, {
        style: {
          borderTop: props.modalSize === "wide" ? "none" : void 0
        },
        children: (0, import_jsx_runtime8.jsxs)(Button, {
          ...
          type: "submit",
          children: [(0, import_jsx_runtime8.jsx)(PinBottomIcon, {
            width: iconSize.sm,
            height: iconSize.sm
...
var ChainIcon = (props) => {
  ...
  return (0, import_jsx_runtime8.jsxs)("div", {
    ...
    }), props.active && (0, import_jsx_runtime8.jsx)(ActiveDot$1, {})]
  });
};
...
var CopyIcon2 = (props) => {
  ...
  return (0, import_jsx_runtime8.jsx)("div", {
    ...
    children: (0, import_jsx_runtime8.jsx)(ToolTip, {
      tip: props.tip,
      side: props.side,
      align: props.align,
      children: props.hasCopied || hasCopied ? (0, import_jsx_runtime8.jsx)(CheckIconStyled, {}) : (0, import_jsx_runtime8.jsx)(CopyIcon, {})
    })
  });
};
...
var Modal = (props) => {
  const [open, setOpen] = (0, import_react5.useState)(props.open);
  ...
  return (0, import_jsx_runtime8.jsxs)(Root3, {
    open,
    onOpenChange: props.setOpen,
    children: [props.trigger && (0, import_jsx_runtime8.jsx)(Trigger3, {
      asChild: true,
      children: props.trigger
    }), (0, import_jsx_runtime8.jsxs)(Portal3, {
      children: [!props.hide && (0, import_jsx_runtime8.jsx)(Overlay, {
        asChild: true,
        children: (0, import_jsx_runtime8.jsx)(Overlay2, {
          ref: overlayRef
        })
      }), (0, import_jsx_runtime8.jsx)(FocusScope, {
        trapped: !props.hide,
        children: (0, import_jsx_runtime8.jsx)(Content4, {
          asChild: true,
          children: (0, import_jsx_runtime8.jsxs)(DialogContent2, {
            ref: contentRef,
            style: props.hide ? {
              width: 0,
              height: 0,
            ...
            children: [props.size === "compact" ? (0, import_jsx_runtime8.jsxs)(DynamicHeight, {
              maxHeight: compactModalMaxHeight,
              children: [props.children, " "]
            }) : props.children, !props.hideCloseIcon && (0, import_jsx_runtime8.jsx)(CrossContainer, {
              children: (0, import_jsx_runtime8.jsx)(Close, {
                asChild: true,
                children: (0, import_jsx_runtime8.jsx)(IconButton, {
                  type: "button",
                  "aria-label": "Close",
                  children: (0, import_jsx_runtime8.jsx)(Cross2Icon, {
                    width: iconSize.md,
                    height: iconSize.md,
                    style: {
                      color: "inherit"
...
function useEmbeddedWallet() {
  ...
  const connect = (0, import_react5.useCallback)(async (authParams) => {
  ...
  const sendVerificationEmail = (0, import_react5.useCallback)(async (_ref) => {
    let {
      email
    } = _ref;
...
function NetworkSelector(props) {
  ...
  return (0, import_jsx_runtime8.jsx)(CustomThemeProvider, {
    theme,
    children: (0, import_jsx_runtime8.jsx)(Modal, {
      size: "compact",
      open: props.open,
      setOpen: (value) => {
        if (!value && onClose) {
      ...
      children: (0, import_jsx_runtime8.jsx)(NetworkSelectorContent, {
        ...props
      })
    })
  });
...
function NetworkSelectorContent(props) {
  ...
  const deferredSearchTerm = (0, import_react5.useDeferredValue)(searchTerm);
  ...
  const recentChains = (0, import_react5.useMemo)(() => {
    if (deferredSearchTerm === "") {
  ...
  const handleSwitch = (0, import_react5.useCallback)((chain) => {
    if (onSwitch) {
      onSwitch(chain);
    }
    if (onClose) {
  ...
  return (0, import_jsx_runtime8.jsxs)(Container, {
    children: [(0, import_jsx_runtime8.jsx)(Container, {
      p: "lg",
      children: props.onBack ? (0, import_jsx_runtime8.jsx)(ModalHeader, {
        title: locale.title,
        onBack: props.onBack
      }) : (0, import_jsx_runtime8.jsx)(ModalTitle, {
        children: locale.title
      })
    }), (0, import_jsx_runtime8.jsxs)(Root23, {
      className: "TabsRoot",
      defaultValue: "all",
      children: [props.showTabs !== false && (0, import_jsx_runtime8.jsxs)(import_jsx_runtime8.Fragment, {
        children: [(0, import_jsx_runtime8.jsx)(Container, {
          px: "lg",
          children: (0, import_jsx_runtime8.jsxs)(List, {
            className: "TabsList",
            ...
            children: [(0, import_jsx_runtime8.jsx)(TabButton, {
              className: "TabsTrigger",
              value: "all",
              children: locale.allNetworks
            }), (0, import_jsx_runtime8.jsx)(TabButton, {
              className: "TabsTrigger",
              value: "mainnet",
      ...
      }), props.showTabs === false && (0, import_jsx_runtime8.jsx)(Spacer, {
        y: "xxs"
      }), chains.length > 10 && (0, import_jsx_runtime8.jsxs)(import_jsx_runtime8.Fragment, {
        children: [(0, import_jsx_runtime8.jsx)(Container, {
          px: "lg",
          children: (0, import_jsx_runtime8.jsxs)("div", {
            ...
            children: [(0, import_jsx_runtime8.jsx)(StyledMagnifyingGlassIcon, {
              width: iconSize.md,
              height: iconSize.md
            }), (0, import_jsx_runtime8.jsx)(Input, {
              style: {
            ...
            }), deferredSearchTerm !== searchTerm && (0, import_jsx_runtime8.jsx)("div", {
              style: {
                position: "absolute",
                right: spacing.md
              },
        ...
        px: "md",
        children: [(0, import_jsx_runtime8.jsx)(Content3, {
          className: "TabsContent",
          value: "all",
          style: {
            outline: "none"
          },
          children: (0, import_jsx_runtime8.jsx)(NetworkTab, {
            allChains,
            type: "all",
            popularChains,
            recentChains,
        ...
        }), (0, import_jsx_runtime8.jsx)(Content3, {
          className: "TabsContent",
          value: "mainnet",
          style: {
            outline: "none"
      ...
      }), onCustomClick && (0, import_jsx_runtime8.jsxs)(import_jsx_runtime8.Fragment, {
        children: [(0, import_jsx_runtime8.jsx)(Line, {}), (0, import_jsx_runtime8.jsx)(Container, {
          p: "lg",
          children: (0, import_jsx_runtime8.jsx)(Button, {
            fullWidth: true,
            variant: "link",
...
var NetworkTab = (props) => {
  const allChains = (0, import_react5.useMemo)(() => filterChainByType(props.allChains, props.type), [props.type, props.allChains]);
  const recentChains = (0, import_react5.useMemo)(() => filterChainByType(props.recentChains || [], props.type), [props.type, props.recentChains]);
  const popularChains = (0, import_react5.useMemo)(() => filterChainByType(props.popularChains || [], props.type), [props.type, props.popularChains]);
  ...
  return (0, import_jsx_runtime8.jsxs)(Container, {
    ...
    children: [recentChains.length > 0 && (0, import_jsx_runtime8.jsxs)("div", {
      children: [(0, import_jsx_runtime8.jsx)(SectionLabel, {
        children: locale.recentlyUsed
      }), (0, import_jsx_runtime8.jsx)(Spacer, {
        y: "sm"
      }), (0, import_jsx_runtime8.jsx)(NetworkList, {
        chains: recentChains,
    ...
    }), popularChains.length > 0 && (0, import_jsx_runtime8.jsxs)("div", {
      children: [(0, import_jsx_runtime8.jsx)(SectionLabel, {
    ...
    }), (popularChains.length > 0 || recentChains.length > 0) && (0, import_jsx_runtime8.jsxs)(import_jsx_runtime8.Fragment, {
      children: [(0, import_jsx_runtime8.jsx)(SectionLabel, {
...
var NetworkList = (0, import_react5.memo)(function NetworkList2(props) {
  const switchChain = useSwitchChain();
  const activeChainId = useChainId();
  const [switchingChainId, setSwitchingChainId] = (0, import_react5.useState)(-1);
  const [errorSwitchingChainId, setErrorSwitchingChainId] = (0, import_react5.useState)(-1);
  ...
  const [isLoading, setIsLoading] = (0, import_react5.useState)(props.chains.length > 100);
  (0, import_react5.useEffect)(() => {
    if (isLoading) {
      setTimeout(() => {
        requestAnimationFrame(() => {
  ...
  if (isLoading) {
    return (0, import_jsx_runtime8.jsx)(Container, {
      px: "xxs",
      children: (0, import_jsx_runtime8.jsx)(NetworkListUl, {
        children: new Array(10).fill(0).map((_, i) => (0, import_jsx_runtime8.jsx)(Skeleton, {
          height: "48px"
        }, i))
      })
    });
  }
  return (0, import_jsx_runtime8.jsx)(NetworkListUl, {
    children: props.chains.map((chain) => {
      ...
      return (0, import_jsx_runtime8.jsx)("li", {
        children: RenderChain ? (0, import_jsx_runtime8.jsx)(RenderChain, {
          switchChain: () => {
            handleSwitch(chain);
          },
          chain,
          ...
          close: props.close
        }) : (0, import_jsx_runtime8.jsx)(ChainButton, {
          chain,
          confirming,
...
var ChainButton = (0, import_react5.memo)(function ChainButton2(props) {
  const twLocale = useTWLocale();
  const {
    confirming,
    onClick,
  ...
  const activeChainId = useChainId();
  const chainName = (0, import_jsx_runtime8.jsxs)("span", {
    children: [chain.name, " "]
  });
  return (0, import_jsx_runtime8.jsxs)(NetworkButton, {
    "data-active": activeChainId === chain.chainId,
    onClick,
    children: [(0, import_jsx_runtime8.jsx)(ChainIcon, {
      chain,
      size: iconSize.lg,
      active: activeChainId === chain.chainId,
      loading: "lazy"
    }), confirming || switchingFailed ? (0, import_jsx_runtime8.jsxs)("div", {
      style: {
        display: "flex",
        flexDirection: "column",
        gap: spacing.xs
      },
      children: [chainName, (0, import_jsx_runtime8.jsxs)(Container, {
        animate: "fadein",
        flex: "row",
        gap: "xs",
        children: [confirming && (0, import_jsx_runtime8.jsxs)(import_jsx_runtime8.Fragment, {
          children: [(0, import_jsx_runtime8.jsx)(Text, {
            size: "xs",
            color: "accentText",
        ...
        }), switchingFailed && (0, import_jsx_runtime8.jsx)(Container, {
          animate: "fadein",
          children: (0, import_jsx_runtime8.jsx)(Text, {
            size: "xs",
            color: "danger",
...
function ReceiveFunds(props) {
  ...
  return (0, import_jsx_runtime8.jsxs)(Container, {
    ...
    children: [(0, import_jsx_runtime8.jsx)(ModalHeader, {
      ...
      flex: "row",
      center: "x",
      children: (0, import_jsx_runtime8.jsx)(QRCode, {
        qrCodeUri: address,
        size: 310,
        QRIcon: (0, import_jsx_runtime8.jsx)(Img, {
          src: props.iconUrl,
          width: iconSize.xxl,
          height: iconSize.xxl
        })
      ...
      y: "xl"
    }), (0, import_jsx_runtime8.jsxs)(WalletAddressContainer, {
      onClick: onCopy,
      children: [(0, import_jsx_runtime8.jsx)(Text, {
        color: "primaryText",
        size: "md",
        children: shortenString(address || "")
      }), (0, import_jsx_runtime8.jsx)(CopyIcon2, {
        text: address || "",
        tip: "Copy address",
        hasCopied
      })]
...
function TokenIcon(props) {
  ...
  if (isNativeToken$1(token)) {
    return (0, import_jsx_runtime8.jsx)(NativeTokenIcon, {
      chainId: props.chainId,
      nativeToken: token,
      size: props.size
    });
  }
  return (0, import_jsx_runtime8.jsx)(Img, {
    src: token.icon,
...
function TokenSelector(props) {
  ...
  if (screen === "select-chain" && chainSelection) {
    return (0, import_jsx_runtime8.jsx)(NetworkSelectorContent, {
      showTabs: false,
      onBack: () => setScreen("base"),
      open: true,
      chains: chainSelection.chains,
      renderChain: (renderChainProps) => {
        return (0, import_jsx_runtime8.jsx)(ChainButton, {
  ...
  return (0, import_jsx_runtime8.jsxs)(Container, {
    ...
    children: [(0, import_jsx_runtime8.jsx)(Container, {
      ...
      children: [(0, import_jsx_runtime8.jsx)(Spacer, {
        y: "md"
      }), props.chainSelection && (0, import_jsx_runtime8.jsx)(import_jsx_runtime8.Fragment, {
        children: (0, import_jsx_runtime8.jsxs)(Container, {
          px: "lg",
          children: [(0, import_jsx_runtime8.jsx)(Text, {
            size: "sm",
            ...
            y: "xxs"
          }), (0, import_jsx_runtime8.jsxs)(SelectTokenBtn, {
            fullWidth: true,
            variant: "secondary",
            onClick: () => {
            ...
            children: [(0, import_jsx_runtime8.jsx)(ChainIcon, {
              ...
              size: iconSize.lg,
              fallbackImage: fallbackChainIcon
            }), chainQuery.data ? (0, import_jsx_runtime8.jsxs)(Text, {
              color: "primaryText",
              size: "sm",
              children: [" ", chainQuery.data.name]
            }) : (0, import_jsx_runtime8.jsx)(Skeleton, {
              height: fontSize.md
            }), (0, import_jsx_runtime8.jsx)(ChevronDownIcon, {
              width: iconSize.sm,
              height: iconSize.sm,
              style: {
                marginLeft: "auto"
        ...
        y: "md"
      }), (filteredList.length > 0 || !input) && (0, import_jsx_runtime8.jsxs)(Container, {
        flex: "column",
        gap: "xs",
        px: "lg",
        scrollY: true,
        ...
        children: [!input && (0, import_jsx_runtime8.jsx)(SelectTokenButton, {
          onClick: () => {
          ...
          return (0, import_jsx_runtime8.jsx)(SelectTokenButton, {
            onClick: () => props.onTokenSelect(token),
            token,
            chainId: props.chainId
          }, token.address);
        })]
      }), filteredList.length === 0 && tokenQuery.isLoading && (0, import_jsx_runtime8.jsx)(Container, {
        animate: "fadein",
        p: "lg",
        flex: "column",
        gap: "md",
      ...
      }), filteredList.length === 0 && !tokenQuery.isLoading && input && (0, import_jsx_runtime8.jsxs)(Container, {
        animate: "fadein",
        p: "lg",
        flex: "column",
        gap: "md",
        ...
        color: "secondaryText",
        children: [(0, import_jsx_runtime8.jsx)(CrossCircledIcon, {
          width: iconSize.lg,
          height: iconSize.lg
...
function SelectTokenButton(props) {
  ...
  return (0, import_jsx_runtime8.jsxs)(SelectTokenBtn, {
    fullWidth: true,
    variant: "secondary",
    onClick: props.onClick,
    children: [(0, import_jsx_runtime8.jsx)(TokenIcon, {
      token: props.token,
      chainId: props.chainId,
      size: "lg"
    }), (0, import_jsx_runtime8.jsxs)(Container, {
      flex: "column",
      gap: "xxs",
      children: [tokenName ? (0, import_jsx_runtime8.jsx)(Text, {
        size: "sm",
        color: "primaryText",
        children: tokenName
      }) : (0, import_jsx_runtime8.jsx)(Skeleton, {
        height: fontSize.md,
        width: "150px"
      }), tokenBalanceQuery.data ? (0, import_jsx_runtime8.jsxs)(Text, {
        size: "xs",
...
function SendFunds(props) {
  ...
  const [token, setToken] = (0, import_react5.useState)(defaultToken);
  const [receiverAddress, setReceiverAddress] = (0, import_react5.useState)("");
  const [amount, setAmount] = (0, import_react5.useState)("0");
  const tokenList = props.supportedTokens[chainId] || [];
  if (screen === "tokenSelector") {
    return (0, import_jsx_runtime8.jsx)(TokenSelector, {
      tokenList,
      onBack: () => {
        setScreen("base");
      },
  ...
  return (0, import_jsx_runtime8.jsx)(SendFundsForm, {
    token,
    onTokenSelect: () => {
...
function SendFundsForm(props) {
  ...
  const isValidReceiverAddress = (0, import_react5.useMemo)(() => {
  ...
  if (sendTokenMutation.isSuccess) {
    return (0, import_jsx_runtime8.jsxs)(Container, {
      ...
      children: [(0, import_jsx_runtime8.jsx)(ModalHeader, {
        ...
        color: "success",
        children: [(0, import_jsx_runtime8.jsx)(CheckCircledIcon, {
          width: iconSize.xl,
          height: iconSize.xl
        }), (0, import_jsx_runtime8.jsxs)(Text, {
          color: "success",
  ...
  return (0, import_jsx_runtime8.jsxs)(Container, {
    ...
    children: [(0, import_jsx_runtime8.jsx)(ModalHeader, {
      ...
      children: [(0, import_jsx_runtime8.jsx)(Label, {
        htmlFor: "token",
        color: "secondaryText",
        children: locale.token
      }), (0, import_jsx_runtime8.jsx)(Spacer, {
        y: "sm"
      }), (0, import_jsx_runtime8.jsxs)(Button, {
        id: "token",
        variant: "outline",
        fullWidth: true,
        style: {
        ...
        children: [(0, import_jsx_runtime8.jsx)(TokenIcon, {
          ...
          children: [tokenName ? (0, import_jsx_runtime8.jsx)(Text, {
            ...
            height: fontSize.xs,
            width: "150px"
          }), balanceQuery.data ? (0, import_jsx_runtime8.jsx)(Text, {
            size: "xs",
      ...
      }), showInvalidAddressError && (0, import_jsx_runtime8.jsxs)(import_jsx_runtime8.Fragment, {
        children: [(0, import_jsx_runtime8.jsx)(Spacer, {
          y: "xs"
        }), (0, import_jsx_runtime8.jsx)(Text, {
          color: "danger",
        ...
        }), (0, import_jsx_runtime8.jsx)(CurrencyBadge, {
          children: (0, import_jsx_runtime8.jsxs)(Text, {
            size: "xs",
        ...
        children: [sendTokenMutation.isLoading ? locale.sending : locale.submitButton, sendTokenMutation.isLoading && (0, import_jsx_runtime8.jsx)(Spinner, {
          size: "sm",
          color: "accentButtonText"
        })]
      })]
...
var Drawer = (0, import_react5.forwardRef)(function Drawer_(props, ref) {
  return (0, import_jsx_runtime8.jsx)(import_jsx_runtime8.Fragment, {
    children: (0, import_jsx_runtime8.jsxs)(DrawerContainer, {
      ref,
      children: [(0, import_jsx_runtime8.jsx)(CrossContainer, {
        children: (0, import_jsx_runtime8.jsx)(IconButton, {
          type: "button",
          "aria-label": "Close",
          onClick: props.close,
...
function useDrawer() {
  ...
  const drawerOverlayRef = (0, import_react5.useRef)(null);
...
function PaymentSelection() {
  return (0, import_jsx_runtime8.jsxs)("div", {
    children: [(0, import_jsx_runtime8.jsx)(Text, {
      ...
      children: [(0, import_jsx_runtime8.jsx)(CheckButton, {
        isChecked: true,
        variant: "outline",
        children: (0, import_jsx_runtime8.jsx)(Container, {
          gap: "xxs",
        ...
        }), (0, import_jsx_runtime8.jsx)(FloatingBadge, {
...
function TokenSymbol(props) {
  if (!isNativeToken$1(props.token)) {
    return (0, import_jsx_runtime8.jsx)(Text, {
      size: props.size,
      color: props.color || "primaryText",
      children: props.token.symbol
    });
  }
  return (0, import_jsx_runtime8.jsx)(NativeTokenSymbol, {
    chainId: props.chainId,
    size: props.size,
    color: props.color
  });
...
function NativeTokenSymbol(props) {
  ...
  if (!data) {
    return (0, import_jsx_runtime8.jsx)(Skeleton, {
      width: "70px",
  ...
  return (0, import_jsx_runtime8.jsxs)(Container, {
    children: [(0, import_jsx_runtime8.jsx)("div", {
      ...
      children: (0, import_jsx_runtime8.jsxs)(Container, {
        ...
        }), (0, import_jsx_runtime8.jsx)(TokenSymbol, {
          token: props.token,
          chainId: props.chainId,
          size: "lg",
          color: "secondaryText"
      ...
      flex: "row",
      center: "x",
      children: (0, import_jsx_runtime8.jsxs)(TokenButton$1, {
        variant: "secondary",
        fullWidth: true,
        style: {
          fontSize: fontSize.sm
        ...
        children: [(0, import_jsx_runtime8.jsxs)(Container, {
          ...
          children: [(0, import_jsx_runtime8.jsx)(TokenIcon, {
            ...
            children: [(0, import_jsx_runtime8.jsx)(TokenSymbol, {
              token: props.token,
              chainId: props.chainId,
              size: "sm"
            }), ((_a = chainQuery.data) == null ? void 0 : _a.name) ? (0, import_jsx_runtime8.jsx)(Text, {
              size: "xs",
              color: "secondaryText",
              children: chainQuery.data.name
            }) : (0, import_jsx_runtime8.jsx)(Skeleton, {
...
var AccentFailIcon = (props) => {
  return (0, import_jsx_runtime8.jsxs)("svg", {
    ...
    children: [(0, import_jsx_runtime8.jsxs)("g", {
    ...
    }), (0, import_jsx_runtime8.jsxs)("defs", {
      children: [(0, import_jsx_runtime8.jsxs)("linearGradient", {
      ...
      }), (0, import_jsx_runtime8.jsx)("clipPath", {
        id: "clip0_4036_4155",
...
function ConfirmationScreen(props) {
  ...
  const [swapTx, setSwapTx] = (0, import_react5.useState)();
  const isApprovalRequired = props.buyWithCryptoQuote.approval !== void 0;
  const [step, setStep] = (0, import_react5.useState)(isApprovalRequired ? "approval" : "swap");
  ...
  if (swapTx) {
    return (0, import_jsx_runtime8.jsx)(WaitingForConfirmation, {
      onBack: () => {
        props.onBack();
      },
  ...
  return (0, import_jsx_runtime8.jsxs)(Container, {
    ...
    children: [(0, import_jsx_runtime8.jsx)(ModalHeader, {
      ...
      y: "lg"
    }), (0, import_jsx_runtime8.jsx)(ConfirmItem, {
      label: "Receive",
      children: (0, import_jsx_runtime8.jsx)(TokenInfo, {
      ...
      label: "Fees",
      children: (0, import_jsx_runtime8.jsx)(SwapFees, {
      ...
      y: "lg"
    }), isApprovalRequired && (0, import_jsx_runtime8.jsxs)(import_jsx_runtime8.Fragment, {
      children: [(0, import_jsx_runtime8.jsx)(Spacer, {
        y: "sm"
      }), (0, import_jsx_runtime8.jsxs)(Container, {
        gap: "sm",
        ...
        center: "y",
        color: "accentText",
        children: [(0, import_jsx_runtime8.jsx)(Step, {
          isDone: step === "swap",
          isActive: step === "approval",
          label: step === "approval" ? "Approve" : "Approved"
        }), (0, import_jsx_runtime8.jsx)(ConnectorLine, {}), (0, import_jsx_runtime8.jsx)(Step, {
          isDone: false,
          label: "Confirm",
          isActive: step === "swap"
        })]
    ...
    }), status === "error" && (0, import_jsx_runtime8.jsxs)(import_jsx_runtime8.Fragment, {
      children: [(0, import_jsx_runtime8.jsxs)(Container, {
        flex: "row",
        gap: "xs",
        center: "y",
      ...
      gap: "xs",
      children: [step === "approval" ? "Approve" : "Confirm", status === "pending" && (0, import_jsx_runtime8.jsx)(Spinner, {
        size: "sm",
        color: "accentButtonText"
      })]
    })]
...
function Step(props) {
  return (0, import_jsx_runtime8.jsxs)(Container, {
    ...
    children: [(0, import_jsx_runtime8.jsx)(Circle, {
      children: props.isDone ? (0, import_jsx_runtime8.jsx)(CheckIcon, {
        width: iconSize.sm,
        height: iconSize.sm
      }) : (0, import_jsx_runtime8.jsx)(PulsingDot, {
...
function TokenInfo(props) {
  ...
  return (0, import_jsx_runtime8.jsxs)(Container, {
    ...
    children: [(0, import_jsx_runtime8.jsxs)(Container, {
      ...
      }), (0, import_jsx_runtime8.jsx)(TokenIcon, {
        token: props.token,
        chainId: props.chainId,
        size: "sm"
      })]
    }), chainQuery.data ? (0, import_jsx_runtime8.jsx)(Text, {
      size: "sm",
      children: chainQuery.data.name
    }) : (0, import_jsx_runtime8.jsx)(Skeleton, {
      width: "100px",
...
function ConfirmItem(props) {
  return (0, import_jsx_runtime8.jsxs)(import_jsx_runtime8.Fragment, {
    ...
    }), (0, import_jsx_runtime8.jsx)(Line, {})]
  });
}
  ...
  return (0, import_jsx_runtime8.jsx)(Container, {
    ...
    children: (0, import_jsx_runtime8.jsxs)(Container, {
      ...
      children: [(0, import_jsx_runtime8.jsx)(ModalHeader, {
        ...
        children: [(0, import_jsx_runtime8.jsx)(Spacer, {
          y: "xxl"
        }), isSuccess ? (0, import_jsx_runtime8.jsx)(CheckCircledIcon, {
          width: iconSize["4xl"],
          height: iconSize["4xl"]
        }) : isFailed ? (0, import_jsx_runtime8.jsx)(AccentFailIcon, {
          size: iconSize["4xl"]
        }) : (0, import_jsx_runtime8.jsxs)("div", {
          style: {
            position: "relative"
        ...
        }), !isFailed && (0, import_jsx_runtime8.jsxs)(import_jsx_runtime8.Fragment, {
          children: [(0, import_jsx_runtime8.jsx)(Spacer, {
            y: "lg"
          }), (0, import_jsx_runtime8.jsxs)("div", {
            children: [(0, import_jsx_runtime8.jsxs)(Text, {
        ...
        y: "xl"
      }), !isFailed && (0, import_jsx_runtime8.jsx)(Button, {
        variant: "accent",
        fullWidth: true,
...
function PayWithCrypto(props) {
  ...
  return (0, import_jsx_runtime8.jsx)(Container, {
    ...
    children: (0, import_jsx_runtime8.jsxs)(Container, {
      ...
      children: [(0, import_jsx_runtime8.jsxs)(TokenButton, {
        variant: "secondary",
        onClick: props.onSelectToken,
        children: [(0, import_jsx_runtime8.jsx)(TokenIcon, {
          token: props.token,
          ...
          }), ((_a = chainQuery.data) == null ? void 0 : _a.name) ? (0, import_jsx_runtime8.jsxs)(Text, {
            size: "xs",
            children: [" ", chainQuery.data.name]
          }) : (0, import_jsx_runtime8.jsx)(Skeleton, {
            width: "90px",
        ...
        children: [props.isLoading ? (0, import_jsx_runtime8.jsx)(Skeleton, {
          width: "120px",
          height: fontSize.md
        }) : (0, import_jsx_runtime8.jsx)(Text, {
          size: "md",
          ...
          center: "y",
          color: "secondaryText",
          children: [(0, import_jsx_runtime8.jsx)(WalletIcon, {
            size: fontSize.xs
          }), balanceQuery.data ? (0, import_jsx_runtime8.jsx)(Text, {
            size: "xs",
            color: "secondaryText",
...
function SwapScreen(props) {
  ...
  if (!chainId || !activeWallet || !clientId || !activeAddress || !activeWalletConfig || !supportedChains) {
    return (0, import_jsx_runtime8.jsx)(LoadingScreen, {});
  }
  return (0, import_jsx_runtime8.jsx)(SwapScreenContent, {
    ...props,
...
function SwapScreenContent(props) {
  ...
  const [isSwitching, setIsSwitching] = (0, import_react5.useState)(false);
  const switchActiveWalletChain = useSwitchChain();
  const walletSupportedChains = useSupportedChains();
  const [screen, setScreen] = (0, import_react5.useState)("main");
  const [drawerScreen, setDrawerScreen] = (0, import_react5.useState)();
  const {
    drawerRef,
    drawerOverlayRef,
    onClose
  ...
  const [tokenAmount, setTokenAmount] = (0, import_react5.useState)("");
  const [hasEditedAmount, setHasEditedAmount] = (0, import_react5.useState)(false);
  const isChainSupported = (0, import_react5.useMemo)(() => supportedChains.find((c) => c.chainId === activeChainId), [activeChainId, supportedChains]);
  const defaultChainId = isChainSupported ? activeChainId : 1;
  const [fromChainId, setFromChainId] = (0, import_react5.useState)(defaultChainId);
  const [toChainId, setToChainId] = (0, import_react5.useState)(defaultChainId);
  const [address, setAddress] = (0, import_react5.useState)(activeAddress);
  const [fromToken, setFromToken] = (0, import_react5.useState)(NATIVE_TOKEN);
  const [toToken, setToToken] = (0, import_react5.useState)(((_a = props.supportedTokens[toChainId]) == null ? void 0 : _a[0]) || NATIVE_TOKEN);
  ...
  const [finalizedQuote, setFinalizedQuote] = (0, import_react5.useState)();
  ...
  if (screen === "confirmation" && quoteToConfirm) {
    return (0, import_jsx_runtime8.jsx)(ConfirmationScreen, {
      clientId,
  ...
  return (0, import_jsx_runtime8.jsx)(Container, {
    ...
    children: (0, import_jsx_runtime8.jsxs)("div", {
      ...
      children: [drawerScreen && (0, import_jsx_runtime8.jsxs)(import_jsx_runtime8.Fragment, {
        children: [(0, import_jsx_runtime8.jsx)(DrawerOverlay, {
          ref: drawerOverlayRef
        }), (0, import_jsx_runtime8.jsx)(Drawer, {
          ref: drawerRef,
          close: closeDrawer,
          children: (0, import_jsx_runtime8.jsx)(DrawerContent, {
            drawerScreen,
            quote: swapQuote,
            activeWallet,
            activeAddress,
        ...
        children: [(0, import_jsx_runtime8.jsx)(ModalHeader, {
          ...
          y: "lg"
        }), !hasEditedAmount && (0, import_jsx_runtime8.jsx)(Spacer, {
          y: "xl"
        }), (0, import_jsx_runtime8.jsx)(BuyTokenInput, {
          value: tokenAmount,
        ...
        px: "lg",
        children: [hasEditedAmount && (0, import_jsx_runtime8.jsxs)("div", {
          children: [(0, import_jsx_runtime8.jsx)(PaymentSelection, {}), (0, import_jsx_runtime8.jsx)(Spacer, {
            y: "md"
          }), (0, import_jsx_runtime8.jsx)(PayWithCrypto, {
            ...
            children: [(0, import_jsx_runtime8.jsxs)(Container, {
              ...
              color: "accentText",
              p: "sm",
              children: [(0, import_jsx_runtime8.jsx)(ClockIcon, {
                width: iconSize.sm,
                height: iconSize.sm
              }), buyWithCryptoQuoteQuery.isLoading ? (0, import_jsx_runtime8.jsx)(Skeleton, {
                height: fontSize.xs,
                width: "50px"
              }) : (0, import_jsx_runtime8.jsx)(Text, {
                size: "xs",
            ...
            }), (0, import_jsx_runtime8.jsxs)(FeesButton, {
              variant: "secondary",
              onClick: () => {
              ...
              children: [(0, import_jsx_runtime8.jsx)(Container, {
                ...
                flex: "row",
                center: "both",
                children: (0, import_jsx_runtime8.jsx)(ViewFeeIcon, {
                  size: iconSize.sm
                })
              }), (0, import_jsx_runtime8.jsx)(Text, {
                size: "xs",
            ...
            children: [(0, import_jsx_runtime8.jsx)(Text, {
              ...
              y: "xxs"
            }), (0, import_jsx_runtime8.jsx)(WalletSelectorButton, {
              activeAddress,
              activeWalletConfig: props.activeWalletConfig,
              address,
              activeWallet,
            ...
            flex: "column",
            gap: "md",
            children: isSwapQuoteError && (0, import_jsx_runtime8.jsxs)("div", {
              children: [(0, import_jsx_runtime8.jsxs)(Container, {
                flex: "row",
                gap: "xs",
                center: "y",
        ...
        }), switchChainRequired && (0, import_jsx_runtime8.jsx)(Button, {
          fullWidth: true,
          variant: "accent",
          ...
          children: hasEditedAmount ? (0, import_jsx_runtime8.jsxs)(import_jsx_runtime8.Fragment, {
            children: [isSwitching && (0, import_jsx_runtime8.jsx)(Spinner, {
              size: "sm",
              color: "accentButtonText"
...
function DrawerContent(props) {
  ...
  const isValidAddress = (0, import_react5.useMemo)(() => (0, import_utils3.isAddress)(address), [address]);
  const showError = !!address && !isValidAddress;
  return (0, import_jsx_runtime8.jsxs)(DynamicHeight, {
    children: [drawerScreen === "fees" && (0, import_jsx_runtime8.jsxs)("div", {
      children: [(0, import_jsx_runtime8.jsx)(Text, {
        size: "lg",
        color: "primaryText",
        children: "Fees"
        ...
        y: "lg"
      }), quote && (0, import_jsx_runtime8.jsx)(SwapFees, {
        quote,
        align: "left"
      })]
    }), drawerScreen === "address" && (0, import_jsx_runtime8.jsxs)("div", {
      children: [(0, import_jsx_runtime8.jsx)(Text, {
        size: "lg",
        color: "primaryText",
        children: "Send to"
        ...
        children: [(0, import_jsx_runtime8.jsx)(StyledInput, {
      ...
      }), showError && (0, import_jsx_runtime8.jsxs)(import_jsx_runtime8.Fragment, {
        children: [(0, import_jsx_runtime8.jsx)(Spacer, {
          y: "xxs"
        }), (0, import_jsx_runtime8.jsx)(Text, {
          color: "danger",
...
function WalletSelectorButton(props) {
  return (0, import_jsx_runtime8.jsxs)(AccountButton, {
    variant: "secondary",
    fullWidth: true,
    onClick: props.onClick,
    children: [props.activeAddress === props.address ? (0, import_jsx_runtime8.jsx)(Img, {
    ...
    }), props.chevron && (0, import_jsx_runtime8.jsx)(ChevronDownIcon, {
      width: iconSize.sm,
      height: iconSize.sm,
      style: {
        marginLeft: "auto"
...
var BuyIcon = (props) => {
  return (0, import_jsx_runtime8.jsxs)("svg", {
    ...
    }), (0, import_jsx_runtime8.jsx)("defs", {
...
function SwapTransactionsScreen(props) {
  var _a, _b, _c, _d, _e;
  const [pageIndex, setPageIndex] = (0, import_react5.useState)(0);
  const _historyQuery = useSwapTransactions(pageIndex);
  const inMemoryPendingTxs = (0, import_react5.useSyncExternalStore)(swapTransactionsStore.subscribe, swapTransactionsStore.getValue);
  const txInfosToShow = [];
  ...
  (_b = _historyQuery.data) == null ? void 0 : _b.page.forEach((tx) => {
    var _a2, _b2, _c2;
    txInfosToShow.push({
      boughChainId: ((_a2 = tx.destination) == null ? void 0 : _a2.token.chainId) || tx.quote.toToken.chainId,
      transactionHash: tx.source.transactionHash,
      boughtTokenAmount: ((_b2 = tx.destination) == null ? void 0 : _b2.amount) || tx.quote.toAmount,
      boughtTokenSymbol: ((_c2 = tx.destination) == null ? void 0 : _c2.token.symbol) || tx.quote.toToken.symbol || "",
      status: tx.status,
  ...
  return (0, import_jsx_runtime8.jsxs)(Container, {
    ...
    children: [(0, import_jsx_runtime8.jsx)(Container, {
      ...
      children: [(0, import_jsx_runtime8.jsxs)(Container, {
        ...
        px: "lg",
        expand: true,
        children: [noTransactions && !_historyQuery.isLoading && (0, import_jsx_runtime8.jsxs)(Container, {
          flex: "column",
          gap: "md",
          center: "both",
          color: "secondaryText",
        ...
        }), noTransactions && _historyQuery.isLoading && (0, import_jsx_runtime8.jsx)(Container, {
          flex: "row",
          center: "both",
          style: {
            minHeight: "250px"
          ...
          return (0, import_jsx_runtime8.jsx)(TransactionInfo, {
            txInfo
          }, txInfo.transactionHash);
        }), _historyQuery.isLoading && txInfosToShow.length > 0 && (0, import_jsx_runtime8.jsxs)(import_jsx_runtime8.Fragment, {
          children: [(0, import_jsx_runtime8.jsx)(Skeleton, {
            width: "100%",
            height: "68px"
          }), (0, import_jsx_runtime8.jsx)(Skeleton, {
            width: "100%",
        ...
        p: "lg",
        children: _historyQuery.data && !hidePagination && (0, import_jsx_runtime8.jsxs)("div", {
          style: {
            display: "grid",
            gridTemplateColumns: "1fr 1fr",
            gap: spacing.sm
          ...
          children: [(0, import_jsx_runtime8.jsxs)(Button, {
            ...
            children: ["Next", (0, import_jsx_runtime8.jsx)(ArrowRightIcon, {
              width: iconSize.sm,
              height: iconSize.sm
            })]
          })]
    ...
    }), (0, import_jsx_runtime8.jsx)(Line, {}), (0, import_jsx_runtime8.jsx)(Container, {
      p: "lg",
      children: (0, import_jsx_runtime8.jsx)(ButtonLink, {
        fullWidth: true,
        variant: "accent",
...
function TransactionInfo(props) {
  ...
  return (0, import_jsx_runtime8.jsx)(TxHashLink, {
    ...
    children: (0, import_jsx_runtime8.jsxs)(Container, {
      ...
      center: "y",
      gap: "md",
      children: [(0, import_jsx_runtime8.jsxs)(IconBox, {
        "data-box": true,
        children: [(0, import_jsx_runtime8.jsx)(BuyIcon, {
          size: iconSize.sm
        }), (0, import_jsx_runtime8.jsx)("div", {
          style: {
            position: "absolute",
          ...
          children: (0, import_jsx_runtime8.jsx)(CryptoIcon, {
            size: iconSize.sm
          })
        })]
      }), (0, import_jsx_runtime8.jsxs)("div", {
        ...
        children: [(0, import_jsx_runtime8.jsxs)(Container, {
          ...
          children: [(0, import_jsx_runtime8.jsxs)(Container, {
            ...
            }), statusMeta.loading && (0, import_jsx_runtime8.jsx)(Spinner, {
              size: "xs",
              color: "accentText"
            })]
          }), ((_d = chainQuery.data) == null ? void 0 : _d.name) ? (0, import_jsx_runtime8.jsxs)(Text, {
            size: "sm",
            children: [" ", chainQuery.data.name]
          }) : (0, import_jsx_runtime8.jsx)(Skeleton, {
            width: "120px",
...
var ConnectedWalletDetails = (props) => {
  ...
  const swapTxs = (0, import_react5.useSyncExternalStore)(swapTransactionsStore.subscribe, swapTransactionsStore.getValue);
  ...
  const [overrideWalletIconUrl, setOverrideWalletIconUrl] = (0, import_react5.useState)(void 0);
  const [screen, setScreen] = (0, import_react5.useState)("main");
  ...
  const trigger = props.detailsBtn ? (0, import_jsx_runtime8.jsx)("div", {
    children: (0, import_jsx_runtime8.jsx)(props.detailsBtn, {})
  }) : (0, import_jsx_runtime8.jsxs)(WalletInfoButton, {
    type: "button",
    ...
    children: [(0, import_jsx_runtime8.jsx)(Img, {
      ...
      flex: "column",
      gap: "xxs",
      children: [(activeWallet == null ? void 0 : activeWallet.walletId) === walletIds.localWallet ? (0, import_jsx_runtime8.jsx)(Text, {
        color: "danger",
        size: "xs",
        style: {
          minWidth: "70px"
      ...
      }) : addressOrENS ? (0, import_jsx_runtime8.jsx)(Text, {
        size: "sm",
        color: "primaryText",
        weight: 500,
        ...
        height: fontSize.sm,
        width: "88px"
      }), balanceQuery.data ? (0, import_jsx_runtime8.jsxs)(Text, {
  ...
  const networkSwitcherButton = (0, import_jsx_runtime8.jsxs)(MenuButton, {
    type: "button",
    ...
    }), (0, import_jsx_runtime8.jsx)(StyledChevronRightIcon, {
      width: iconSize.sm,
      height: iconSize.sm,
      style: {
        flexShrink: 0,
  ...
  let content = (0, import_jsx_runtime8.jsxs)("div", {
    children: [(0, import_jsx_runtime8.jsx)(Spacer, {
      y: "xl"
    }), (0, import_jsx_runtime8.jsxs)(Container, {
      px: "lg",
      ...
      children: [(0, import_jsx_runtime8.jsx)(Img, {
        ...
        children: [(0, import_jsx_runtime8.jsx)(Text, {
          ...
          size: "md",
          children: addressOrENS
        }), (0, import_jsx_runtime8.jsx)(IconButton, {
          style: {
            padding: "3px"
          },
          "data-test": "copy-address",
          children: (0, import_jsx_runtime8.jsx)(CopyIcon2, {
            text: address || "",
        ...
        weight: 500,
        size: "sm",
        children: [" ", balanceQuery.data ? Number(balanceQuery.data.displayValue).toFixed(3) : (0, import_jsx_runtime8.jsx)(Skeleton, {
          height: "1em",
          width: "100px"
      ...
      px: "lg",
      children: [(0, import_jsx_runtime8.jsx)(ConnectedToSmartWallet, {}), (0, import_jsx_runtime8.jsx)(EmbeddedWalletDetails, {}), (0, import_jsx_runtime8.jsxs)(Container, {
        style: {
          display: "grid",
          gridTemplateColumns: `repeat(${buttonsToShow}, 1fr)`,
          gap: spacing.sm
        },
        children: [props.hideSendButton !== true && (0, import_jsx_runtime8.jsxs)(Button, {
          variant: "outline",
          style: {
            fontSize: fontSize.sm,
            display: "flex",
          ...
          children: [(0, import_jsx_runtime8.jsx)(PaperPlaneIcon, {
            width: iconSize.sm,
            height: iconSize.sm,
            style: {
        ...
        }), props.hideReceiveButton !== true && (0, import_jsx_runtime8.jsxs)(Button, {
          variant: "outline",
          style: {
            fontSize: fontSize.sm,
            display: "flex",
        ...
        }), props.hideBuyButton !== true && (0, import_jsx_runtime8.jsxs)(Button, {
          variant: "outline",
          style: {
            fontSize: fontSize.sm,
            display: "flex",
          ...
          children: [(0, import_jsx_runtime8.jsx)(Container, {
            ...
            flex: "row",
            center: "both",
            children: (0, import_jsx_runtime8.jsx)(PlusIcon, {
              width: iconSize.sm,
              height: iconSize.sm
            })
          }), "Buy"]
    ...
    }), buttonsToShow === 0 ? null : (0, import_jsx_runtime8.jsx)(Spacer, {
      y: "md"
    }), (0, import_jsx_runtime8.jsxs)(Container, {
      px: "md",
      children: [(0, import_jsx_runtime8.jsxs)(Container, {
        ...
        children: [networkSwitcherButton, (0, import_jsx_runtime8.jsxs)(MenuButton, {
          onClick: () => {
          ...
          children: [(0, import_jsx_runtime8.jsx)(TextAlignJustifyIcon, {
            width: iconSize.md,
            height: iconSize.md
          }), (0, import_jsx_runtime8.jsxs)(Container, {
            flex: "row",
            ...
            }), pendingSwapTxs && pendingSwapTxs.length > 0 && (0, import_jsx_runtime8.jsx)(BadgeCount, {
              children: pendingSwapTxs.length
            })]
          })]
        }), personalWallet && personalWalletConfig && !props.hideSwitchToPersonalWallet && (0, import_jsx_runtime8.jsx)(WalletSwitcher, {
          wallet: personalWallet,
          name: locale.personalWallet
        }), wrapperWalletConfig && wrapperWallet && (0, import_jsx_runtime8.jsx)(WalletSwitcher, {
          name: wrapperWallet.walletId === walletIds.smartWallet ? locale.smartWallet : wrapperWalletConfig.meta.name,
          wallet: wrapperWallet
        }), isActuallyMetaMask && activeWalletConfig && activeWalletConfig.isInstalled && activeWalletConfig.isInstalled() && !isMobile() && (0, import_jsx_runtime8.jsxs)(MenuButton, {
          type: "button",
          onClick: () => {
            activeWallet.switchAccount();
            setIsOpen(false);
          },
          children: [(0, import_jsx_runtime8.jsx)(ShuffleIcon, {
            width: iconSize.md,
            height: iconSize.md
          }), (0, import_jsx_runtime8.jsx)(Text, {
            color: "primaryText",
        ...
        }), showFaucet && ((chain == null ? void 0 : chain.faucets) && chain.faucets.length > 0 || (chain == null ? void 0 : chain.chainId) === c1337.chainId) && (0, import_jsx_runtime8.jsxs)(MenuLink, {
          ...
          children: [(0, import_jsx_runtime8.jsx)(Container, {
            ...
            center: "both",
            color: "secondaryText",
            children: (0, import_jsx_runtime8.jsx)(FundsIcon, {
              size: iconSize.md
            })
          }), locale.requestTestnetFunds]
        }), (activeWallet == null ? void 0 : activeWallet.walletId) === walletIds.localWallet && (0, import_jsx_runtime8.jsx)("div", {
          children: (0, import_jsx_runtime8.jsxs)(MenuButton, {
            onClick: () => {
              setScreen("export");
            },
            style: {
        ...
        }), props.detailsModalFooter && (0, import_jsx_runtime8.jsx)(props.detailsModalFooter, {
          close: () => setIsOpen(false)
        })]
      }), (0, import_jsx_runtime8.jsx)(Spacer, {
        y: "md"
      })]
    }), props.hideDisconnect !== true && (0, import_jsx_runtime8.jsxs)(Container, {
      children: [(0, import_jsx_runtime8.jsx)(Line, {}), (0, import_jsx_runtime8.jsx)(Spacer, {
        y: "sm"
      }), (0, import_jsx_runtime8.jsx)(Container, {
        px: "md",
        children: (0, import_jsx_runtime8.jsxs)(MenuButton, {
          ...
          children: [(0, import_jsx_runtime8.jsx)(ExitIcon, {
            width: iconSize.md,
            height: iconSize.md
          }), (0, import_jsx_runtime8.jsx)(Text, {
            color: "primaryText",
    ...
    }), (activeWallet == null ? void 0 : activeWallet.walletId) === walletIds.localWallet && (0, import_jsx_runtime8.jsxs)(import_jsx_runtime8.Fragment, {
      children: [(0, import_jsx_runtime8.jsx)(Line, {}), (0, import_jsx_runtime8.jsx)(Container, {
        py: "md",
        children: (0, import_jsx_runtime8.jsx)(Text, {
          size: "xs",
  ...
  if (screen === "network-switcher") {
    content = (0, import_jsx_runtime8.jsx)(NetworkSelectorContent, {
      open: true,
      theme: props.theme,
      chains,
    ...
    content = (0, import_jsx_runtime8.jsx)(ExportLocalWallet, {
      modalSize: "compact",
    ...
    content = (0, import_jsx_runtime8.jsx)(SendFunds, {
    ...
    content = (0, import_jsx_runtime8.jsx)(SwapTransactionsScreen, {
      onBack: () => setScreen("main")
    });
  } else if (screen === "buy") {
    content = (0, import_jsx_runtime8.jsx)(SwapScreen, {
      onBack: () => setScreen("main"),
      supportedTokens: props.supportedTokens,
      onViewPendingTx: () => setScreen("pending-tx")
    });
  } else if (screen === "receive") {
    content = (0, import_jsx_runtime8.jsx)(ReceiveFunds, {
  ...
  return (0, import_jsx_runtime8.jsx)(Modal, {
    size: "compact",
    trigger,
    open: isOpen,
    setOpen: setIsOpen,
...
function WalletSwitcher(_ref) {
  ...
  const walletContext = useWalletContext();
  const locale = useTWLocale().connectWallet;
  return (0, import_jsx_runtime8.jsxs)(MenuButton, {
    type: "button",
    onClick: () => {
    ...
    children: [(0, import_jsx_runtime8.jsx)(EnterIcon, {
      width: iconSize.md,
      height: iconSize.md
    }), (0, import_jsx_runtime8.jsxs)(Text, {
      color: "primaryText",
...
function ConnectedToSmartWallet() {
  ...
  const address = useAddress();
  const locale = useTWLocale().connectWallet;
  const [isSmartWalletDeployed, setIsSmartWalletDeployed] = (0, import_react5.useState)(false);
  (0, import_react5.useEffect)(() => {
  ...
  const content = (0, import_jsx_runtime8.jsxs)(Container, {
    flex: "row",
    gap: "xxs",
    center: "both",
    children: [(0, import_jsx_runtime8.jsx)(ActiveDot, {}), locale.connectedToSmartWallet]
  });
  if (chain && address && (activeWallet == null ? void 0 : activeWallet.walletId) === walletIds.smartWallet) {
    return (0, import_jsx_runtime8.jsxs)(import_jsx_runtime8.Fragment, {
      children: [isSmartWalletDeployed ? (0, import_jsx_runtime8.jsx)(Link, {
        color: "secondaryText",
...
var SignatureScreen = (_ref) => {
  ...
  const {
    auth
  } = (0, import_react5.useContext)(ModalConfigCtx);
  const [status, setStatus] = (0, import_react5.useState)("idle");
  const {
    login
  } = useLogin();
  ...
  const signIn = (0, import_react5.useCallback)(async () => {
    var _a;
    try {
      setStatus("signing");
      await wait(1e3);
  ...
  if (walletConfig == null ? void 0 : walletConfig.isHeadless) {
    return (0, import_jsx_runtime8.jsx)(HeadlessSignIn, {
      signIn,
      status
    });
  }
  ...
  return (0, import_jsx_runtime8.jsxs)(Container, {
    ...
    children: [(0, import_jsx_runtime8.jsx)(Container, {
      ...
      center: "y",
      expand: true,
      children: status === "idle" ? (0, import_jsx_runtime8.jsxs)(import_jsx_runtime8.Fragment, {
        children: [walletConfig && (0, import_jsx_runtime8.jsx)(Container, {
          flex: "row",
          center: "x",
          animate: "fadein",
          py: "3xl",
          children: (0, import_jsx_runtime8.jsx)(PulsatingContainer, {
            children: (0, import_jsx_runtime8.jsx)(Img, {
      ...
      }) : (0, import_jsx_runtime8.jsxs)(import_jsx_runtime8.Fragment, {
        children: [walletConfig && (0, import_jsx_runtime8.jsx)(Container, {
          py: "3xl",
          children: (0, import_jsx_runtime8.jsx)(WalletLogoSpinner, {
            error: status === "failed",
          ...
          }), status === "signing" && (0, import_jsx_runtime8.jsx)(Text, {
            center: true,
            multiline: true,
            balance: true,
            children: isSafeWallet ? (0, import_jsx_runtime8.jsx)(SafeWalletInstruction, {}) : (0, import_jsx_runtime8.jsx)(import_jsx_runtime8.Fragment, {
              children: locale.signingScreen.prompt
            })
          }), isSafeWallet && status === "signing" && (0, import_jsx_runtime8.jsxs)(Container, {
            children: [(0, import_jsx_runtime8.jsx)(Spacer, {
              y: "sm"
            }), (0, import_jsx_runtime8.jsxs)(Button, {
              fullWidth: true,
              ...
              children: [" ", locale.signingScreen.approveTransactionInSafe, (0, import_jsx_runtime8.jsx)(ExternalLinkIcon, {
                width: iconSize.sm,
                height: iconSize.sm
              })]
            })]
          }), status === "failed" && (0, import_jsx_runtime8.jsxs)(Container, {
            children: [(0, import_jsx_runtime8.jsx)(Spacer, {
              y: "sm"
            }), (0, import_jsx_runtime8.jsxs)(Button, {
              fullWidth: true,
              ...
              children: [(0, import_jsx_runtime8.jsx)(ReloadIcon, {
                width: iconSize.sm,
                height: iconSize.sm
    ...
    }), (termsOfServiceUrl || privacyPolicyUrl) && (0, import_jsx_runtime8.jsx)(Container, {
      p: "md",
      animate: "fadein",
      children: (0, import_jsx_runtime8.jsx)(TOS, {
        termsOfServiceUrl,
...
function SafeWalletInstruction() {
  ...
  return (0, import_jsx_runtime8.jsx)(import_jsx_runtime8.Fragment, {
    children: isSafePersonalWalletHeadless ? (0, import_jsx_runtime8.jsx)(import_jsx_runtime8.Fragment, {
...
function HeadlessSignIn(_ref2) {
  ...
  return (0, import_jsx_runtime8.jsxs)(Container, {
    ...
    children: [(0, import_jsx_runtime8.jsx)(ModalHeader, {
      ...
      children: [status === "signing" && (0, import_jsx_runtime8.jsx)(Spinner, {
        size: "xl",
        color: "accentText"
      }), status === "failed" && (0, import_jsx_runtime8.jsx)(import_jsx_runtime8.Fragment, {
        children: (0, import_jsx_runtime8.jsxs)(Container, {
          children: [(0, import_jsx_runtime8.jsx)(Spacer, {
            y: "lg"
          }), (0, import_jsx_runtime8.jsx)(Text, {
...
function ConnectWallet(props) {
  ...
  const setModalConfig = (0, import_react5.useContext)(SetModalConfigCtx);
  ...
  const [showSignatureModal, setShowSignatureModal] = (0, import_react5.useState)(false);
  const address = useAddress();
  const {
    user
  } = useUser();
  ...
  const supportedTokens = (0, import_react5.useMemo)(() => {
  ...
  return (0, import_jsx_runtime8.jsxs)(CustomThemeProvider, {
    theme,
    children: [(0, import_jsx_runtime8.jsx)(Modal, {
      size: "compact",
      ...
      children: (0, import_jsx_runtime8.jsx)(SignatureScreen, {
        modalSize: "compact",
      ...
      if (!activeWallet) {
        return (0, import_jsx_runtime8.jsx)(AnimatedButton, {
          disabled: isLoading,
          ...
          children: isLoading ? (0, import_jsx_runtime8.jsx)(Spinner, {
            size: "sm",
      ...
      if (props.switchToActiveChain && isNetworkMismatch && activeChainSetExplicitly) {
        return (0, import_jsx_runtime8.jsx)(SwitchNetworkButton, {
          style: props.style,
        ...
        return (0, import_jsx_runtime8.jsx)(Button, {
          ...
          children: (0, import_jsx_runtime8.jsxs)(Container, {
            ...
            center: "y",
            gap: "sm",
            children: [(0, import_jsx_runtime8.jsx)(LockIcon, {
              size: iconSize.sm
            }), (0, import_jsx_runtime8.jsxs)("span", {
              children: [" ", locale.connectWallet.signIn, " "]
            })]
          })
        });
      }
      return (0, import_jsx_runtime8.jsx)(ConnectedWalletDetails, {
        theme,
...
function SwitchNetworkButton(props) {
  ...
  const switchChain = useSwitchChain();
  const [switching, setSwitching] = (0, import_react5.useState)(false);
  const locale = useTWLocale();
  ...
  return (0, import_jsx_runtime8.jsx)(AnimatedButton, {
    ...
    children: switching ? (0, import_jsx_runtime8.jsx)(Spinner, {
      size: "sm",
      color: "primaryButtonText"
...
function StartScreen() {
  ...
  if (WelcomeScreen) {
    if (typeof WelcomeScreen === "function") {
      return (0, import_jsx_runtime8.jsx)(WelcomeScreen, {});
    }
  }
  ...
  return (0, import_jsx_runtime8.jsxs)(Container, {
    ...
    children: [(0, import_jsx_runtime8.jsxs)(Container, {
      ...
      children: [(0, import_jsx_runtime8.jsx)(Container, {
        flex: "row",
        center: "x",
        children: img ? (0, import_jsx_runtime8.jsx)(Img, {
          src: img.src,
          width: img.width ? String(img.width) : void 0,
          height: img.height ? String(img.height) : void 0
        }) : (0, import_jsx_runtime8.jsx)(GlobalContainer, {
          children: (0, import_jsx_runtime8.jsx)(GlobeIcon, {
            size: "150"
          })
        })
      }), (0, import_jsx_runtime8.jsx)(Spacer, {
        ...
        y: "lg"
      }), (0, import_jsx_runtime8.jsx)(Link, {
        target: "_blank",
        center: true,
      ...
      gap: "lg",
      children: (0, import_jsx_runtime8.jsxs)("div", {
        children: [showTOS && (0, import_jsx_runtime8.jsx)(TOS, {
          termsOfServiceUrl,
          privacyPolicyUrl
        }), showThirdwebBranding !== false && (0, import_jsx_runtime8.jsx)(Container, {
          style: {
            paddingTop: spacing.xl
          },
          children: (0, import_jsx_runtime8.jsx)(PoweredByThirdweb, {})
        })]
      })
    })]
  });
...
var ConnectModalContent = (props) => {
  ...
  const authConfig = useThirdwebAuthContext();
  const [handleConnectedPending, setIsHandleConnectedPending] = (0, import_react5.useState)(false);
  const handleConnected = (0, import_react5.useCallback)((_wallet) => {
    var _a2;
    if (onConnect) {
      onConnect(_wallet);
    }
  ...
  const handleBack = (0, import_react5.useCallback)(() => {
  ...
  const walletList = (0, import_jsx_runtime8.jsx)(WalletSelector, {
    title,
    walletConfigs,
    onGetStarted: () => {
  ...
  const getStarted = (0, import_jsx_runtime8.jsx)(StartScreen, {});
  const getWalletUI = (walletConfig) => {
    const ConnectUI2 = walletConfig.connectUI || HeadlessConnectUI;
    return (0, import_jsx_runtime8.jsx)(ConnectUI2, {
  ...
  const signatureScreen = (0, import_jsx_runtime8.jsx)(SignatureScreen, {
    onDone: onClose,
    modalSize,
    termsOfServiceUrl: modalConfig.termsOfServiceUrl,
    privacyPolicyUrl: modalConfig.privacyPolicyUrl
  });
  return (0, import_jsx_runtime8.jsx)(ScreenSetupContext.Provider, {
    value: props.screenSetup,
    children: isWideModal ? (0, import_jsx_runtime8.jsxs)("div", {
      style: {
        height: "100%",
        display: "grid",
        gridTemplateColumns: "300px 1fr"
      },
      children: [(0, import_jsx_runtime8.jsxs)(LeftContainer, {
        children: [" ", walletList, " "]
      }), (0, import_jsx_runtime8.jsxs)(Container, {
        flex: "column",
        scrollY: true,
        relative: true,
        children: [screen === reservedScreens.signIn && signatureScreen, screen === reservedScreens.main && (0, import_jsx_runtime8.jsx)(import_jsx_runtime8.Fragment, {
          children: getStarted
...
var ConnectModal = () => {
  ...
  const setIsWalletModalOpen = useSetIsWalletModalOpen();
  const [hideModal, setHideModal] = (0, import_react5.useState)(false);
  const connectionStatus = useConnectionStatus();
  ...
  const onHide = (0, import_react5.useCallback)(() => setHideModal(true), []);
  const onShow = (0, import_react5.useCallback)(() => setHideModal(false), []);
  return (0, import_jsx_runtime8.jsx)(CustomThemeProvider, {
    theme,
    children: (0, import_jsx_runtime8.jsx)(Modal, {
      hide: hideModal,
      ...
      children: (0, import_jsx_runtime8.jsx)(ConnectModalContent, {
        screenSetup,
        onHide,
        onShow,
...
function ConnectEmbed(props) {
  ...
  if (show) {
    return (0, import_jsx_runtime8.jsx)(WalletUIStatesProvider, {
      ...walletUIStatesProps,
      children: (0, import_jsx_runtime8.jsxs)(CustomThemeProvider, {
        theme: walletUIStatesProps.theme,
        children: [(0, import_jsx_runtime8.jsx)(ConnectEmbedContent, {
          ...props,
          onConnect: props.onConnect
        }), (0, import_jsx_runtime8.jsx)(SyncedWalletUIStates, {
          ...walletUIStatesProps
        })]
      })
    });
...
var ConnectEmbedContent = (props) => {
  ...
  if (isAutoConnecting || connectionStatus === "unknown") {
    content = (0, import_jsx_runtime8.jsx)(Container, {
      flex: "column",
      center: "both",
      style: {
        minHeight: "300px"
    ...
    content = (0, import_jsx_runtime8.jsx)(ConnectModalContent, {
      screenSetup,
      isOpen: true,
      onClose: () => {
        setScreen(initialScreen);
  ...
  return (0, import_jsx_runtime8.jsx)(EmbedContainer, {
    className: props.className,
    style: {
      height: "auto",
    ...
    children: (0, import_jsx_runtime8.jsxs)(DynamicHeight, {
      children: [" ", content, " "]
    })
  });
};
...
var ConnectModalInline = (props) => {
  ...
  return (0, import_jsx_runtime8.jsx)(WalletUIStatesProvider, {
    ...
    children: (0, import_jsx_runtime8.jsxs)(CustomThemeProvider, {
      theme: walletUIStatesProps.theme,
      children: [(0, import_jsx_runtime8.jsx)(ConnectModalInlineContent, {
        className: props.className,
        modalSize
      }), (0, import_jsx_runtime8.jsx)(SyncedWalletUIStates, {
        ...walletUIStatesProps
...
function ConnectModalInlineContent(props) {
  const screenSetup = useSetupScreen();
  const content = (0, import_jsx_runtime8.jsxs)(import_jsx_runtime8.Fragment, {
    children: [(0, import_jsx_runtime8.jsx)(ConnectModalContent, {
      screenSetup,
      onHide: () => {
      },
    ...
    }), (0, import_jsx_runtime8.jsx)(CrossContainer, {
      children: (0, import_jsx_runtime8.jsx)(IconButton, {
        type: "button",
        "aria-label": "Close",
        children: (0, import_jsx_runtime8.jsx)(Cross2Icon, {
  ...
  return (0, import_jsx_runtime8.jsx)(ConnectModalInlineContainer, {
    className: props.className,
    style: {
    ...
    children: props.modalSize === "compact" ? (0, import_jsx_runtime8.jsxs)(DynamicHeight, {
      children: [" ", content, " "]
    }) : content
  });
}
...
var ModelViewer = (0, import_react5.lazy)(() => import("./ModelViewer-ad6f3167.browser.esm-LNLMG3TC.js"));
var PlayButton = (_ref) => {
  let {
    onClick,
    isPlaying
  ...
  return (0, import_jsx_runtime8.jsx)("button", {
    ...
    onMouseDown,
    onMouseUp,
    children: !isPlaying ? (0, import_jsx_runtime8.jsx)(CarbonPlayFilledAlt, {
      style: {
        width: "66%",
        height: "66%"
      }
    }) : (0, import_jsx_runtime8.jsx)(CarbonPauseFilled, {
      style: {
        width: "66%",
        height: "66%"
      }
...
var VideoPlayer = (() => import_react5.default.forwardRef(function Video_Player(_ref2, ref) {
  let {
    src,
    alt,
    poster,
  ...
  const [playing, setPlaying] = (0, import_react5.useState)(!requireInteraction);
  const [muted, setMuted] = (0, import_react5.useState)(true);
  (0, import_react5.useEffect)(() => {
    if (videoRef.current) {
      if (playing) {
        try {
  ...
  return (0, import_jsx_runtime8.jsxs)("div", {
    ...
    ...restProps,
    children: [(0, import_jsx_runtime8.jsx)("video", {
    ...
    }), poster && (0, import_jsx_runtime8.jsx)("img", {
      src: poster,
      style: {
        objectFit: "contain",
        pointerEvents: "none",
      ...
      alt
    }), (0, import_jsx_runtime8.jsx)(PlayButton, {
      onClick: () => {
...
var AudioPlayer = (() => import_react5.default.forwardRef(function Audio_Player(_ref3, ref) {
  let {
    src,
    alt,
    poster,
  ...
  return (0, import_jsx_runtime8.jsxs)("div", {
    ...
    ...restProps,
    children: [poster ? (0, import_jsx_runtime8.jsx)("img", {
      height,
      width,
      src: poster,
      style: {
      ...
      children: (0, import_jsx_runtime8.jsx)(CarbonDocumentAudio, {
        style: {
          height: "64px",
          width: "64px"
        }
      ...
      isPlaying: playing
    }), (0, import_jsx_runtime8.jsx)("audio", {
...
var IframePlayer = (() => import_react5.default.forwardRef(function Iframe_Player(_ref4, ref) {
  let {
    src,
    alt,
    poster,
  ...
  return (0, import_jsx_runtime8.jsxs)("div", {
    ...
    ...restProps,
    children: [(0, import_jsx_runtime8.jsx)("iframe", {
...
var LinkPlayer = (() => import_react5.default.forwardRef(function Link_Player(_ref5, ref) {
  let {
    src,
    alt,
    style,
  ...
  return (0, import_jsx_runtime8.jsx)("div", {
    ...
    children: (0, import_jsx_runtime8.jsx)("div", {
      ...
      children: (0, import_jsx_runtime8.jsxs)("div", {
        ...
        children: [(0, import_jsx_runtime8.jsx)(CarbonDocumentUnknown, {
          style: {
            maxWidth: "128px",
            minWidth: "48px",
            width: "50%",
...
var MediaRenderer = (() => import_react5.default.forwardRef(function Media_Renderer(_ref6, ref) {
  let {
    src,
    poster,
    alt,
  ...
  if (!videoOrImageSrc.mimeType) {
    ...
    return (0, import_jsx_runtime8.jsx)(IframePlayer, {
      style: mergedStyle,
    ...
    return (0, import_jsx_runtime8.jsx)(import_react5.Suspense, {
      fallback: poster ? (0, import_jsx_runtime8.jsx)("img", {
        style: mergedStyle,
        src: poster,
        alt,
        ref,
      ...
      children: (0, import_jsx_runtime8.jsx)(ModelViewer, {
        style: mergedStyle,
        src: videoOrImageSrc.url || "",
        poster,
        alt,
    ...
    return (0, import_jsx_runtime8.jsx)(VideoPlayer, {
      style: mergedStyle,
      src: videoOrImageSrc.url,
      poster: possiblePosterSrc.url,
      requireInteraction,
    ...
    return (0, import_jsx_runtime8.jsx)(AudioPlayer, {
      style: mergedStyle,
      src: videoOrImageSrc.url,
      poster: possiblePosterSrc.url,
      requireInteraction,
  ...
  return (0, import_jsx_runtime8.jsx)(LinkPlayer, {
    style: mergedStyle,
    src: videoOrImageSrc.url,
    alt,
    ref,
...
function useResolvedMediaType(uri, mimeType, gatewayUrl) {
  const storage = useStorage();
  const resolvedUrl = (0, import_react5.useMemo)(() => {
    if (!uri) {
      return "";
    }
    if (gatewayUrl) {
...
var ThirdwebNftMedia = (() => import_react5.default.forwardRef(function Thirdweb_NftMedia(_ref, ref) {
  var _a;
  let {
    metadata,
    width = "300px",
  ...
  return (0, import_jsx_runtime8.jsx)(MediaRenderer, {
...
var Popover2 = (props) => {
  return (0, import_jsx_runtime8.jsxs)(Root22, {
    open: props.open,
    onOpenChange: props.onOpenChange,
    children: [(0, import_jsx_runtime8.jsx)(Trigger, {
      asChild: true,
      children: props.children
    }), (0, import_jsx_runtime8.jsx)(Portal2, {
      children: (0, import_jsx_runtime8.jsxs)(PopoverContent2, {
        sideOffset: 7,
        side: "top",
        children: [(0, import_jsx_runtime8.jsx)(Container, {
          flex: "row",
        ...
        }), (0, import_jsx_runtime8.jsx)(PopoverArrow2, {})]
      })
    })]
  });
};
...
var Web3Button = (props) => {
  ...
  const [confirmStatus, setConfirmStatus] = (0, import_react5.useState)("idle");
  ...
  if (!address) {
    return (0, import_jsx_runtime8.jsx)(ConnectWallet, {
      style,
      theme,
  ...
  if (hasMismatch && !isDisabled) {
    const _button = (0, import_jsx_runtime8.jsx)(Button, {
      variant: "primary",
      type,
      ...
      children: confirmStatus === "waiting" ? (0, import_jsx_runtime8.jsx)(Spinner, {
        size: "sm",
        color: "primaryButtonText"
      }) : switchNetworkLabel
    });
    if (requiresConfirmation) {
      button = (0, import_jsx_runtime8.jsx)(Popover2, {
        content: (0, import_jsx_runtime8.jsx)("span", {
    ...
    button = (0, import_jsx_runtime8.jsx)(Button, {
      variant: "primary",
      type,
...
var ThirdwebProvider = (props) => {
  ...
  const signerWalletConfig = (0, import_react5.useMemo)(() => signer ? signerWallet(signer) : void 0, [signer]);
  const ewsRef = (0, import_react5.useRef)(false);
  (0, import_react5.useEffect)(() => {
    if (ewsRef.current) {
      return;
    }
    ...
    const preloadEmbeddedWallet = async () => {
      ...
      if (hasEmbeddedWallet && restProps.clientId) {
        const {
          EmbeddedWalletSdk
        } = await import("./thirdweb-dev-wallets.browser.esm-3FLIEUPF.js");
  ...
  return (0, import_jsx_runtime8.jsx)(ThirdwebLocaleContext.Provider, {
    value: restProps.locale || en(),
    children: (0, import_jsx_runtime8.jsx)(WalletUIStatesProvider, {
      theme,
      children: (0, import_jsx_runtime8.jsx)(CustomThemeProvider, {
        theme,
        children: (0, import_jsx_runtime8.jsxs)(ThirdwebProviderCore, {
          ...restProps,
          theme: typeof theme === "string" ? theme : theme.type,
          supportedWallets: wallets,
          signerWallet: signerWalletConfig,
          children: [children, (0, import_jsx_runtime8.jsx)(ConnectModal, {})]
        })
      })
    })
  });
...
function useRainbowWallet() {
  const connect = useConnect();
  return (0, import_react5.useCallback)(async (connectOptions) => {
    const {
      rainbowWallet
    } = await import("./safeChainSlug-02e3bfeb.browser.esm-TPUJ675K.js").then(function(n) {
      return n.R;
    });
...
function useMetamask() {
  const connect = useConnect();
  return (0, import_react5.useCallback)(async (options) => {
    const {
      metamaskWallet
    } = await import("./safeChainSlug-02e3bfeb.browser.esm-TPUJ675K.js").then(function(n) {
      return n.n;
...
function useFrameWallet() {
  ...
  return (0, import_react5.useCallback)(async (connectOptions) => {
    const {
      frameWallet
    } = await import("./frameWallet-88665c8a.browser.esm-QTZBFOM6.js");
...
function useBloctoWallet() {
  ...
  return (0, import_react5.useCallback)(async (options) => {
    const {
      bloctoWallet
    } = await import("./bloctoWallet-4cc043fb.browser.esm-LAJMV4JS.js");
...
var useEmbeddedWalletSendVerificationEmail = () => {
  const context = useWalletContext();
  const sendVerificationEmail = (0, import_react5.useCallback)(async (email) => {
    if (!context.clientId) {
...
function usePaperWallet() {
  ...
  return (0, import_react5.useCallback)(async (options) => {
    ...
    } = await import("./paperWallet-765c291c.browser.esm-4RSDBBZN.js");
...
function useWalletConnectV1() {
  ...
  return (0, import_react5.useCallback)(async (options) => {
    const {
      walletConnectV1
    } = await import("./walletConnectV1-b4d1e793.browser.esm-ADGORU5G.js");
...
function ConnectUI(props) {
  const locale = useTWLocale();
  return (0, import_jsx_runtime8.jsx)(ExtensionOrWCConnectionUI, {
...
var PaperFormUI = (props) => {
  ...
  return (0, import_jsx_runtime9.jsxs)("div", {
    children: [props.googleLoginSupported && (0, import_jsx_runtime9.jsxs)(import_jsx_runtime9.Fragment, {
      children: [(0, import_jsx_runtime9.jsxs)(SocialButton2, {
        variant: "secondary",
        fullWidth: true,
        onClick: () => {
          googleLogin();
      ...
      }), (0, import_jsx_runtime9.jsx)(TextDivider, {
        text: cwLocale.or,
        py: "lg"
      })]
...
var PaperFormUIScreen = (props) => {
  ...
  return (0, import_jsx_runtime9.jsxs)(Container, {
    ...
    children: [(0, import_jsx_runtime9.jsx)(ModalHeader, {
      ...
      center: "y",
      p: isCompact ? void 0 : "lg",
      children: (0, import_jsx_runtime9.jsx)(PaperFormUI, {
        walletConfig: props.walletConfig,
...
var PaperOTPLoginUI = (props) => {
  ...
  const [recoveryCode, setRecoveryCode] = (0, import_react7.useState)("");
  const {
    createWalletInstance,
    setConnectedWallet,
    setConnectionStatus
  ...
  const [sendEmailStatus, setSendEmailStatus] = (0, import_react7.useState)("sending");
  ...
  const sendEmail = (0, import_react7.useCallback)(async () => {
    setOtpInput("");
    setVerifyStatus("idle");
  ...
  return (0, import_jsx_runtime9.jsxs)(Container, {
    ...
    children: [(0, import_jsx_runtime9.jsx)(Container, {
      ...
      children: (0, import_jsx_runtime9.jsxs)("form", {
        ...
        children: [(0, import_jsx_runtime9.jsxs)(Container, {
        ...
        }), recoveryCodeRequired && (0, import_jsx_runtime9.jsxs)(Container, {
          animate: "fadein",
          px: "lg",
          style: {
            textAlign: "center"
        ...
        }), verifyStatus === "invalid" && (0, import_jsx_runtime9.jsxs)(Container, {
          animate: "fadein",
          children: [(0, import_jsx_runtime9.jsx)(Spacer, {
            y: "md"
          }), (0, import_jsx_runtime9.jsx)(Text, {
          ...
          p: isWideModal ? void 0 : "lg",
          animate: "fadein",
          children: [sendEmailStatus === "error" && (0, import_jsx_runtime9.jsx)(import_jsx_runtime9.Fragment, {
          ...
          }), sendEmailStatus === "sending" && (0, import_jsx_runtime9.jsxs)(Container, {
            flex: "row",
            center: "both",
            gap: "xs",
            style: {
          ...
          }), typeof sendEmailStatus !== "string" && (0, import_jsx_runtime9.jsx)(LinkButton2, {
            onClick: sendEmail,
            type: "button",
...
var PaperGoogleLogin = (props) => {
  ...
  return (0, import_jsx_runtime9.jsx)(Container, {
    ...
    children: (0, import_jsx_runtime9.jsxs)(Container, {
      ...
      children: [(0, import_jsx_runtime9.jsx)(ModalHeader, {
        title: (0, import_jsx_runtime9.jsxs)(Container, {
          flex: "row",
          center: "both",
          gap: "xs",
          children: [(0, import_jsx_runtime9.jsx)(Img, {
            ...
            width: iconSize.md,
            height: iconSize.md
          }), (0, import_jsx_runtime9.jsxs)(ModalTitle, {
            children: [" ", locale.title, " "]
          })]
        }),
        onBack: goBack
...
var paperWallet = (options) => {
  ...
  return {
    ...
    selectUI(props) {
      var _a;
      return (0, import_jsx_runtime9.jsx)(PaperSelectionUI, {
        ...props,
    ...
    connectUI(props) {
      var _a;
      return (0, import_jsx_runtime9.jsx)(PaperConnectUI, {
        ...props,
        recoveryShareManagement: ((_a = finalOptions == null ? void 0 : finalOptions.advancedOptions) == null ? void 0 : _a.recoveryShareManagement) || defaultRecovery,
        providers: oauthOptions ? oauthOptions == null ? void 0 : oauthOptions.providers : void 0
      });
...
var PaperConnectUI = (props) => {
  ...
  if (loginType) {
    ...
    if ("email" in loginType) {
      return (0, import_jsx_runtime9.jsx)(PaperOTPLoginUI, {
        ...props,
      ...
      return (0, import_jsx_runtime9.jsx)(PaperGoogleLogin, {
        ...props,
        goBack: handleBack
      });
    }
  }
  return (0, import_jsx_runtime9.jsx)(PaperFormUIScreen, {
    walletConfig: props.walletConfig,
    googleLoginSupported: props.recoveryShareManagement !== "USER_MANAGED" && !!((_a = props.providers) == null ? void 0 : _a.includes("google")),
    modalSize: props.modalSize,
    onSelect: (_loginType) => {
...
//# sourceMappingURL=chunk-CSE4OU2H.js.map
