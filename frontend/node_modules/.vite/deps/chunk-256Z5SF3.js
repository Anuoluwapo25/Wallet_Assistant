        ...
        children: [(0, import_jsx_runtime10.jsxs)(Container, {
          ...
          children: [(0, import_jsx_runtime10.jsx)(TokenIcon, {
            ...
            children: [(0, import_jsx_runtime10.jsx)(TokenSymbol, {
              ...
              chainId: props.chainId,
              size: "sm"
            }), ((_a = chainQuery.data) == null ? void 0 : _a.name) ? (0, import_jsx_runtime10.jsx)(Text, {
              size: "xs",
              color: "secondaryText",
              children: chainQuery.data.name
            }) : (0, import_jsx_runtime10.jsx)(Skeleton, {
    ...
    children: (0, import_jsx_runtime10.jsxs)(Container, {
      ...
      children: [(0, import_jsx_runtime10.jsxs)(TokenButton, {
        ...
        children: [(0, import_jsx_runtime10.jsx)(TokenIcon, {
          ...
          }), ((_a = chainQuery.data) == null ? void 0 : _a.name) ? (0, import_jsx_runtime10.jsxs)(Text, {
            size: "xs",
            children: [" ", chainQuery.data.name]
          }) : (0, import_jsx_runtime10.jsx)(Skeleton, {
            width: "90px",
...
function SwapScreenContent(props) {
  ...
  const [toToken, setToToken] = (0, import_react8.useState)(((_a = props.supportedTokens[toChainId]) == null ? void 0 : _a[0]) || NATIVE_TOKEN);
    ...
    children: (0, import_jsx_runtime10.jsxs)(Container, {
      ...
      children: [(0, import_jsx_runtime10.jsxs)(IconBox, {
        ...
        children: [(0, import_jsx_runtime10.jsxs)(Container, {
          ...
          }), ((_d = chainQuery.data) == null ? void 0 : _d.name) ? (0, import_jsx_runtime10.jsxs)(Text, {
            size: "sm",
            children: [" ", chainQuery.data.name]
          }) : (0, import_jsx_runtime10.jsx)(Skeleton, {
            width: "120px",
...
var ConnectedWalletDetails = (props) => {
  ...
  const trigger = props.detailsBtn ? (0, import_jsx_runtime10.jsx)("div", {
    ...
    children: [(0, import_jsx_runtime10.jsx)(Img, {
      ...
      flex: "column",
      gap: "xxs",
      children: [(activeWallet == null ? void 0 : activeWallet.walletId) === walletIds.localWallet ? (0, import_jsx_runtime10.jsx)(Text, {
        color: "danger",
        size: "xs",
        style: {
          minWidth: "70px"
  ...
  let content = (0, import_jsx_runtime10.jsxs)("div", {
    children: [(0, import_jsx_runtime10.jsx)(Spacer, {
      ...
      children: [(0, import_jsx_runtime10.jsxs)(Container, {
        ...
        }), showFaucet && ((chain == null ? void 0 : chain.faucets) && chain.faucets.length > 0 || (chain == null ? void 0 : chain.chainId) === c1337.chainId) && (0, import_jsx_runtime10.jsxs)(MenuLink, {
        ...
        }), (activeWallet == null ? void 0 : activeWallet.walletId) === walletIds.localWallet && (0, import_jsx_runtime10.jsx)("div", {
        ...
        }), (activeWallet == null ? void 0 : activeWallet.walletId) === walletIds.embeddedWallet && (0, import_jsx_runtime10.jsx)("div", {
          children: (0, import_jsx_runtime10.jsxs)(MenuButton, {
            onClick: () => {
    ...
    }), (activeWallet == null ? void 0 : activeWallet.walletId) === walletIds.localWallet && (0, import_jsx_runtime10.jsxs)(import_jsx_runtime10.Fragment, {
      children: [(0, import_jsx_runtime10.jsx)(Line, {}), (0, import_jsx_runtime10.jsx)(Container, {
        py: "md",
        children: (0, import_jsx_runtime10.jsx)(Text, {
          size: "xs",
...
var ModelViewer = (0, import_react8.lazy)(() => import("./ModelViewer-ad6f3167.browser.esm-UD2EATOR.js"));
var PlayButton = (_ref) => {
  let {
    onClick,
    isPlaying
  ...
  (0, import_react8.useEffect)(() => {
    ...
    const preloadEmbeddedWallet = async () => {
      ...
      if (hasEmbeddedWallet && restProps.clientId) {
        const {
          EmbeddedWalletSdk
        } = await import("./thirdweb-dev-wallets.browser.esm-SAFUYJQR.js");
...
function useRainbowWallet() {
  ...
  return (0, import_react8.useCallback)(async (connectOptions) => {
    const {
      rainbowWallet
    } = await import("./safeChainSlug-8dca7686.browser.esm-EB3KMRM6.js").then(function(n2) {
      return n2.R;
    });
...
function useFrameWallet() {
  ...
  return (0, import_react8.useCallback)(async (connectOptions) => {
    const {
      frameWallet
    } = await import("./frameWallet-8cc5e47c.browser.esm-TQYY7NHL.js");
...
function useBloctoWallet() {
  ...
  return (0, import_react8.useCallback)(async (options) => {
    const {
      bloctoWallet
    } = await import("./bloctoWallet-4cc043fb.browser.esm-K5A3ZB6T.js");
...
function usePaperWallet() {
  ...
  return (0, import_react8.useCallback)(async (options) => {
    ...
    } = await import("./paperWallet-d2f9a4b2.browser.esm-NLZJOUGR.js");
...
function useWalletConnectV1() {
  ...
  return (0, import_react8.useCallback)(async (options) => {
    const {
      walletConnectV1
    } = await import("./walletConnectV1-7f7a98bb.browser.esm-ZYHW7RNU.js");
...
//# sourceMappingURL=chunk-256Z5SF3.js.map
