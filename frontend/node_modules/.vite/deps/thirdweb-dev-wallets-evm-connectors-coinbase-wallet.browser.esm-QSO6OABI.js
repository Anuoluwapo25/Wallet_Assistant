...
var CoinbaseWalletConnector = class extends WagmiConnector {
  ...
  async getProvider() {
    var _a;
    if (!this._provider) {
      let CoinbaseWalletSDK = (await import("./dist-6TMQW6NK.js")).default;
...
//# sourceMappingURL=thirdweb-dev-wallets-evm-connectors-coinbase-wallet.browser.esm-QSO6OABI.js.map
